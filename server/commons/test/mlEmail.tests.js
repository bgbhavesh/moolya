...
describe('Email Module', () => {
  ...
  //
  it('should send right email object to Email.send', () => {
    const emailObj = {
    ...
    const emailSent = mlE.sendHtml(emailObj);
  ...
  // Demo: Stubbing the method and spying on the arguments passed to the method
  //
  it('should send attachment with to everyone when CC provided', () => {
    const emailObj = {
      from: 'ajitesh.kumar@raksan.in',
      to: 'amit.singh@raksan.in',
      subject: 'Regarding moolya testing',
    ...
    assert(Email.send.calledWithMatch({
      ...
      subject: 'Regarding moolya testing',
      attachments: [{
        contents: 'Just wanted to check how is it going with testing?',
        contentType: 'json',
        fileName: 'helloworld.txt'
      }]
    }));
  ...
  // Demo: Stubbing the method and spying on the arguments passed to the method
  //
  it('should send attachment to everyone when CC not provided', () => {
    const emailObj = {
      from: 'ajitesh.kumar@raksan.in',
      to: 'amit.singh@raksan.in',
      subject: 'Regarding moolya testing',
