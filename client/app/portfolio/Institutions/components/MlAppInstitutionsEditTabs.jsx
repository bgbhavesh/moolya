...
export default class MlAppInstitutionEditTabs extends Component {
  ...
  getTabComponents() {
    const tabs = [

      {
        ...
        title: 'About',
        name: 'About',
        component: <MlInstitutionAboutUs
          client={appClient} isAdmin={false} key="1"
      ...
      },
      {
        ...
        title: 'Management',
        name: 'Management',
        component: <MlInstitutionEditManagement
          key="2" isAdmin={false} client={appClient} tabName={'management'}
      ...
      },
      {
        ...
        title: 'Investor',
        name: 'Investor',
        component: <MlInstitutionInvestor
          client={appClient} isAdmin={false} key="3"
      ...
      },
      {
        ...
        title: 'Data',
        name: 'Data',
        component: <MlInstitutionData
          client={appClient} key="4" getDataDetails={this.getDataDetails.bind(this)}
      ...
      },
      {
        ...
        title: 'Awards',
        name: 'Awards',
        component: <MlInstitutionEditAwards
          client={appClient} isAdmin={false} key="6"
      ...
      },
      {
        ...
        component: <PortfolioLibrary
          key="7" isAdmin={false} client={appClient}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      }, //
      {
        tabClassName: 'tab',
        ...
        title: 'M C & L',
        name: 'M C And L',
        component: <MlInstitutionMCL
          key="8" getInstitutionMCL={this.getInstitutionMCL.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        title: 'Looking For',
        name: 'Looking For',
        component: <MlInstitutionLookingFor
      ...
      },
      {
        ...
        title: 'Partner',
        name: 'Partner',
        component: <MlInstitutionEditPartners
          key="10" getPartnersDetails={this.getPartnersDetails.bind(this)} client={appClient}
      ...
      },
      {
        ...
        title: 'CSR',
        name: 'CSR',
        component: <MlInstitutionCSREditTabs
          client={appClient} isAdmin={false} key="11"
      ...
      },
      {
        ...
        component: <MlInstitutionRAndD
          key="12" getRDDetails={this.getRDDetails.bind(this)}
      ...
      },
      {
        ...
        component: <MlInstitutionIntrapreneur
          key="14" getIntrapreneurDetails={this.getIntrapreneurDetails.bind(this)}
      ...
      },
      {
        ...
        component: <MlInstitutionIncubator
          client={appClient} isAdmin={false} key="15"
  ...
  getAboutus(details, tabName, privatekey, requiredFields) {
    const data = this.state.institutionPortfolio;
