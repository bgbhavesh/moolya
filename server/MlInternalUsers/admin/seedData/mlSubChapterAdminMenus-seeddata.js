 ...
 */
if (Meteor.isServer) {
  MlMenus.upsert({ name: 'mlSubChapterAdminMenu' }, {
    $set: {
       ...
       */
        ...
        },
        {
          ...
          subMenu: [
            ...
            {
              link: '/admin/settings/subChapterNonMoolya/history',
              name: 'History',
              uniqueId: 'subChapterSettings_historyList',
              isLink: true,
              isMenu: true,
              image: '',
              subMenu: [
                {
                  ...
                  name: 'History List',
                  uniqueId: 'subChapterSettings_historyList',
                  subMenuMappingId: 'subChapterSettings_historyList',
                  subMenusId: 'settings',
                  isLink: true,
                  isMenu: false,
                  image: ''
