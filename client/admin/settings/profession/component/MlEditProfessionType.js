...
class MlEditProfessionType extends React.Component {
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/settings/documentProcess/professionList'); } else { toastr.error(response.result); }
    }
  }

  async findProfessionType() {
    const ProfessionTypeId = this.props.config
              ...
              <div className="form_bg">
                <form>
                  <div className="form-group mandatory">
                    ...
                    <input
                      type="text" ref="professionName" placeholder="Profession Name" defaultValue={this.state.data && this.state.data.professionName}
            ...
            <div className="col-md-6 nopadding-right">
              <div className="form_bg">
                <form>
                  <div className="form-group mandatory">
                    <input
                      type="text" ref="professionDisplayName" placeholder="Display Name"
                  ...
                  <div className="form-group">
                    <Moolyaselect
                      multiSelect={false} ref="industry" placeholder="Select Industry" mandatory={true} className="form-control float-label" valueKey={'value'}
