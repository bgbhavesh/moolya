...
export default class MlMoolyaSubChapterAccess extends React.Component {
  ...
  componentWillMount() {
    ...
    if (this.props.assignedDetails && this.props.assignedDetails.externalUser) {
      const externalUserState = this.props.assignedDetails.externalUser;
  ...
  onStatusChangeCanSearchE(e) {
    const status = this.refs.canSearchE.checked
    const externalUser = {
      canSearch: status,
      canView: false,
    ...
    this.props.getMoolyaAccessStatus({ externalUser })
  }

  onStatusChangeCanViewE(e) {
    const status = this.refs.canViewE.checked;
    const externalUser = {
  ...
  onStatusChangeCanTransactE(e) {
    const status = this.refs.canTransactE.checked;
    const externalUser = {
      // canSearch:this.state.externalUser.canSearch?this.state.externalUser.canSearch:false,
      canSearch: status,
  ...
  render() {
    const that = this;
    const userType = that.state.type;
                ...
                <div className="row">
                  <div className="col-md-4">
                    <div className="form-group switch_wrap inline_switch">
                      ...
                      <label className="switch">
                        <input
                          type="checkbox" ref="canSearchE" checked={that.state.externalUser.canSearch}
                  ...
                  <div className="col-md-4">
                    <div className="form-group switch_wrap inline_switch">
                      ...
                      <label className="switch">
                        <input
                          type="checkbox" ref="canViewE" checked={that.state.externalUser.canView}
                  ...
                  <div className="col-md-4">
                    <div className="form-group switch_wrap inline_switch">
                      ...
                      <label className="switch">
                        <input
                          type="checkbox" ref="canTransactE" checked={that.state.externalUser.canTransact}
