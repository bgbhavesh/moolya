...
export default class MlInstitutionCompanyEmployment extends React.Component {
  ...
  fetchDetails() {
    ...
    const empty = _.isEmpty(that.context.institutionPortfolio && that.context.institutionPortfolio.employmentOfCompanyChart)
    if (empty) {
      ...
      this.setState({ loading: false, startupCompanyEmployment: that.context.institutionPortfolio.employmentOfCompanyChart, employmentList: that.context.institutionPortfolio.employmentOfCompanyChart });
    }
  }

  handleFromYearChange(index, e) {
    let details = this.state.data;
    const name = 'eofFromYear';
  ...
  onSaveAction(index, e) {
    ...
    const clients = this.state.startupCompanyEmployment;
    clients[index] = data
    this.setState({ startupCompanyEmployment: clients })
    this.props.getStartupCompanyEmployment(clients);
  ...
  render() {
    const that = this;
    const employemntArray = this.state.employmentList && this.state.employmentList.length > 0 ? this.state.employmentList : []
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-10">
                    <div className="row">
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <input
                          type="text" placeholder="Number of Employment" ref={`eofNumberOfEmployment${defaultIndex}`} className="form-control float-label"
                          id="" name="eofNumberOfEmployment" onBlur={this.employeementHandleBlur.bind(this, defaultIndex)}/>
                      </div>

                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <textarea
                          rows="1" placeholder="About" ref={`eofAbout${defaultIndex}`} className="form-control float-label"
                          id="" name="eofAbout" onBlur={this.aboutHandleBlur.bind(this, defaultIndex)}></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                {that.state.employmentList.map((details, idx) => (<div className="form_inner_block">
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-10">
                    <div className="row">
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <input
                          type="text" placeholder="Number of Employment" ref={`eofNumberOfEmployment${idx}`}
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <textarea
                          rows="1" placeholder="About" ref={`eofAbout${idx}`} className="form-control float-label"
...
MlInstitutionCompanyEmployment.contextTypes = {
