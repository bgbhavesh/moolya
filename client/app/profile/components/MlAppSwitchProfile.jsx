...
export default class MlAppSwitchProfile extends React.Component {
  constructor(props, context) {
    super(props);
    this.state = {
      loading: true, swiper: null, userProfiles: [], currentSlideIndex: 0
    };
  ...
  async switchProfile() {
    ...
    const userProfilesCount = this.state.userProfiles && this.state.userProfiles.length ? this.state.userProfiles.length : 0;
  ...
  render() {
    ...
    const profileDetails = this.state.userProfiles[this.state.currentSlideIndex] || {};
    const profileExists = !!(this.state.userProfiles && this.state.userProfiles.length > 0);
              ...
              <div className="col-md-8">
                <div className="swiper-container profile_container">
                  <div className="swiper-wrapper">
                    ...
                    {this.state.userProfiles.map((prf, idx) => (
