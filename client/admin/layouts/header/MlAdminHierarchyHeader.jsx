...
export default class MlAdminHierarchyHeader extends Component {
  ...
  async findProcess() {
    const documentsList = []
    const response = [{ tabName: 'platformhierarchy', tabCode: 'platform hierarchy' }, { tabName: 'clusterhierarchy', tabCode: 'cluster hierarchy' }, { tabName: 'history', tabCode: 'history' }]
    if (response) {
