...
export default class MlAssignBackendUserList extends React.Component {
  ...
  async fetchAssignUsers() {
    const clusterId = this.props.clusterId ? this.props.clusterId : '';
    const chapterId = this.props.chapterId ? this.props.chapterId : '';
    const subChapterId = this.props.subChapterId ? this.props.subChapterId : '';
    const communityId = this.props.communityId ? this.props.communityId : '';
  ...
  render() {
    const that = this
    const backendUsers = that.state.backendUsers
    return (
      <div>
