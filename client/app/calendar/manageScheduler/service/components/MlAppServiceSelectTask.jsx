...
class MlAppServiceSelectTask extends Component {
  ...
  async componentDidMount() {
    ...
    if (this.props.viewMode && this.props.serviceTask.tasks[0]) {
      const taskId = this.props.serviceTask.tasks[0].id;
  ...
  getTabs() {
    const {
      serviceTask, optionsBySelectService, deleteSelectedTask, viewMode
    } = this.props;
  ...
  getSessionList() {
    const { session } = this.props.serviceTask.selectedTaskDetails;
