...
const mlChapterTabHistoryTableConfig = new MlViewer.View({
  name: 'auditLogTable',
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'CHAPTER,SUBCHAPTER,COMMUNITY,USERS' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
...
export { mlChapterTabHistoryTableConfig };
