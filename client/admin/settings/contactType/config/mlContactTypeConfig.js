...
const mlContactTypeTableConfig = new MlViewer.View({
  ...
  columns: [
    ...
    {
      dataField: 'contactTypeInfo.contactName', title: 'Name', dataSort: true, customComponent(data) { return <div>{data.data.contactTypeInfo.contactName}</div> }
    },
    {
      dataField: 'contactTypeInfo.contactDisplayName', title: 'Display Name', dataSort: true, customComponent(data) { return <div>{data.data.contactTypeInfo.contactDisplayName}</div> }
    },
    {
      dataField: 'contactTypeInfo.aboutContact', title: 'About', dataSort: true, customComponent(data) { return <div>{data.data.contactTypeInfo.aboutContact}</div> }
    },
  ...
  /*  graphQlQuery:gql`
              ...
              ` */
  queryOptions: true,
  buildQueryOptions: config => ({ context: { settingsType: 'CONTACTTYPE' } }),
  graphQlQuery: gql`
