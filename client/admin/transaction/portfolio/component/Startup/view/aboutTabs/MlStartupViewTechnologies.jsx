...
export default class MlStartupViewTechnologies extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'startupTechnologies', quote: JSON.stringify(annotation) }
  ...
  render() {
    ...
    const technologiesArray = that.props.technologiesDetails || [];
    return (
        ...
        <div>
          {technologiesArray && technologiesArray.length ? (
            <div className="col-lg-12">
              <div className="row">
                {technologiesArray.map((details, idx) => (<div className="col-lg-2 col-md-3 col-xs-12 col-sm-4" key={idx}>
