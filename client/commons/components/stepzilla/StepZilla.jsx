  ...
  _jumpToStep(evt) {
    if (evt.currentTarget == undefined) {
      ...
      if (_.isEmpty(this.refs)) {
        ...
        const validate = this.refs && this.refs.activeComponent && this.refs.activeComponent.isValidated ? this.refs.activeComponent.isValidated() : true;
        const isupdated = this.refs && this.refs.activeComponent && this.refs.activeComponent.isUpdated ? this.refs.activeComponent.isUpdated() : true;
        ...
        <div className="multi-step full-height" onKeyDown={this.handleKeyDown}>
          ...
          <div style={this.props.showNavigation ? {} : this.hidden} className="footer-buttons">
            <div>
              ...
              <button
                style={this.state.showFinishBtn ? {} : this.hidden}
                className="step_form_btn pull-right"
