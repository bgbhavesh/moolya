...
class MlEditOfficePackage extends Component{
  constructor(props){
    ...
    this.fetchOfficePackageDetails.bind(this);
  }
  ...
  async fetchOfficePackageDetails(){
    ...
    if(response){
      ...
      this.refs.officeName.value  = response.serviceCardName;
      ...
      _.each(response.applicableCommunities, function (community) {
        applicableCommunities.push(_.omit(community, ['__typename']));
      })
      this.setState({applicableCommunities:applicableCommunities})
    ...
    let MlActionConfig = [
      {
        actionName: 'save',
        showAction: true,
        handler: async(event) => this.props.handler(this.updateOfficePackage.bind(this), this.handleSuccess.bind(this), this.handleError.bind(this))
      },
      {
        showAction: true,
        actionName: 'cancel',
