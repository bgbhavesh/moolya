...
class MlStartupAssets extends Component {
  ...
  componentWillMount() {
    const empty = _.isEmpty(this.context.startupPortfolio && this.context.startupPortfolio.assets)
    if (!empty) {
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.startupAssets
  ...
  onTileClick(index, e) {
    const cloneArray = _.cloneDeep(this.state.startupAssets);
    ...
    this.setState({
      selectedIndex: index, data: details, selectedObject: index, popoverOpen: !(this.state.popoverOpen), selectedVal: details.assetTypeId
    });
    setTimeout(() => {
  ...
  sendDataToParent(isSaveClicked) {
    ...
    const assets = this.state.startupAssets;
  ...
  render() {
    ...
    const assetsArray = that.state.startupAssetsList || [];
            ...
            >
              <div className="col-lg-12">
                <div className="row">
                  ...
                  {assetsArray.map((details, idx) => (<div className="col-lg-2 col-md-3 col-sm-3" key={idx}>
                  ...
                  <div className="medium-popover"><div className="row">
                    <div className="col-md-12">
                      ...
                      <div className="form-group mandatory">
                        ...
                        <input
                          type="number" name="quantity" placeholder="Enter Number of Quantity" ref={'quantity'}
