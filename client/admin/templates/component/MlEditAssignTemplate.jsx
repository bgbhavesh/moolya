...
class MlEditAssignTemplate extends React.Component {
  ...
  async findTemplate() {
    ...
    const subProcessId = response.templatesubProcess;
    if (response) {
  ...
  render() {
    ...
    `;
    const fetchUsers = gql`query($id:String,$displayAllOption:Boolean){
    ...
    const subprocessOption = { options: { variables: { id: this.state.process } } };
    const chapterOption = { options: { variables: { id: this.state.clusters } } };
    const subChapterOption = { options: { variables: { id: this.state.chapters, displayAllOption: true } } };
    const usertypeOption = { options: { variables: { id: this.state.communities, displayAllOption: true } } };
    let identityActive = ''
                ...
                <div className="form_bg left_wrap">
                  ...
                  >
                    <form>
                      ...
                      <div className="form-group">
                        <input
                          ref="templateGroupName" value={this.state.templateGroupName && this.state.templateGroupName} readOnly="true"
                      ...
                      <div className="panel-body">
                        <div className="ml_tabs">
                          <ul className="nav nav-pills">
                            {that.state.steps.map((options, key) => (
                          ...
                          <div className="tab-content clearfix">
                            ...
                            {that.state.templateInfo.map((options, key) => (
