...
const mlSettingsTabHistoryTableConfig = new MlViewer.View({
  ...
  buildQueryOptions: (config) => {
    return {context: {
      moduleName: "CITIES,INDUSTRY,AWARDS,COUNTRIES,DEPARTMENT,DOCUMENTMAPPING,GLOBALSETTINGS,MASTERSETTINGS,HIERARCHY," +
      "Modules,PROCESSMAPPING,ROLES,ROLETYPE,SERVICES,STATES,Status,SUBDEPARTMENT,TAXATION,ACCOUNTTYPES,BUSINESSTYPE," +
      "CITIZENSHIP,DOCUMENTCATEGORIES,DOCUMENTFORMAT,DOCUMENTTYPE,ENTITY,LOOKINGFOR,FUNDINGTYPE,PROFESSION,SPECIFICATION," +
      "STAGEOFCOMPANY,IDENTITYTYPES,PROCESSTYPES,SUBPROCESS,HIERARCHY,FILTERS,TEMPLATE,SUBDOMAIN,ASSETS,TECHNOLOGIES" +
      ""}}
