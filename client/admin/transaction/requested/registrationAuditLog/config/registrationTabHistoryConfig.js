...
const mlRegistrationTabHistoryTableConfig = new MlViewer.View({
  name: 'auditLogTable',
  ...
  columns: [
    ...
    { dataField: 'docRef', title: 'Module Id', dataSort: true },
  ...
  buildQueryOptions: (config) => {
    ...
    return { context: { moduleName: 'REGISTRATION', registrationId } }
...
export { mlRegistrationTabHistoryTableConfig };
