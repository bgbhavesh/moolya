...
export default class MlGenericAchievementsView extends React.Component {
  ...
  viewDetails(id, e) {
    const data = this.props.achievementsList;
  ...
  render() {
    ...
    const arrayList = _this.props.achievementsList ? _this.props.achievementsList : []
    return (
      <div>
                            ...
                            <div className="form_bg">
                              <form>
                                <div className="form-group">
                                  <input
                                    type="text" placeholder="Achievement Name"
                          ...
                          <div className="col-md-6 nopadding-right">
                            <div className="form_bg">
                              <form>
                                <div className="form-group">
                                  <input
                                    type="text" placeholder="Achievement Description"
