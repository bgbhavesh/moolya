...
import MlAppFunderCompanyComponent from "./MlAppFunderCompanyComponent";
...
export default class MlAppFunderCompanyHardReg extends React.Component {
  constructor(props) {
    super(props);
    ...
    let hardRegSteps = [
      {
        ...
        component: <MlAppFunderCompanyComponent {...props} />
      },
      {
