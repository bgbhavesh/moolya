...
const mlPortfolioTabHistoryTableConfig = new MlViewer.View({
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'PORTFOLIO,PORTFOLIOLIBRARY' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
...
export { mlPortfolioTabHistoryTableConfig };
