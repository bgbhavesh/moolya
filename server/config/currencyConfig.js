const currencyType = [
  ...
  {
    _id: 'cc002',
    countryName: 'Akrotiri and Dhekelia (UK)',
  ...
  {
    _id: 'cc003',
    countryName: 'Aland Islands (Finland)',
    currencyName: 'European euro',
    currencyCode: 'EUR',
    isActive: true
  },
  ...
  {
    _id: 'cc014',
    countryName: 'Ascension Island (UK)',
  ...
  {
    _id: 'cc033',
    countryName: 'British Indian Ocean Territory (UK)',
    currencyName: 'United States dollar',
    currencyCode: 'USD',
    isActive: true
  },
  ...
  {
    _id: 'cc043',
    countryName: 'Caribbean Netherlands (Netherlands)',
    currencyName: 'United States dollar',
    currencyCode: 'USD',
    isActive: true
  },
  ...
  {
    _id: 'cc047',
    countryName: 'Chatham Islands (New Zealand)',
  ...
  {
    _id: 'cc050',
    countryName: 'Christmas Island (Australia)',
    currencyName: 'Australian dollar',
    currencyCode: 'AUD',
    isActive: true
  },
  {
    _id: 'cc051',
    countryName: 'Cocos (Keeling) Islands (Australia)',
    currencyName: 'Australian dollar',
    currencyCode: 'AUD',
    isActive: true
  },
  ...
  {
    _id: 'cc061',
    countryName: 'Curacao (Netherlands)',
  ...
  {
    _id: 'cc076',
    countryName: 'Faroe Islands (Denmark)',
    currencyName: 'Faroese krona',
    currencyCode: 'none',
    isActive: true
  },
  {
  ...
  {
    _id: 'cc187',
    countryName: 'Saint Barthelemy (France)',
    currencyName: 'European euro',
    currencyCode: 'EUR',
    isActive: true
  },
  ...
  {
    _id: 'cc210',
    countryName: 'South Georgia Island (UK)',
  ...
  {
    _id: 'cc217',
    countryName: 'Svalbard and Jan Mayen (Norway)',
    currencyName: 'Norwegian krone',
    currencyCode: 'NOK',
    isActive: true
  },
  ...
  {
    _id: 'cc231',
    countryName: 'Tristan da Cunha (UK)',
    currencyName: 'Pound sterling',
    currencyCode: 'GBP',
    isActive: true
  },
...
Meteor.startup(() => {
  const count = MlCurrencyType.find().count()
  const length = currencyType.length
  if (count != length) {
    for (let i = 0; i < currencyType.length; i++) {
      const currencyTypeData = MlCurrencyType.findOne({ _id: currencyType[i]._id });
      if (!currencyTypeData) {
