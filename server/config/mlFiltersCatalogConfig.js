if (Meteor.isServer) {
  const portfolioFilterExists = MlFiltersCatalog.findOne({ moduleName: 'portfolio' });
  ...
  const registrationFilterExists = MlFiltersCatalog.findOne({ moduleName: 'registration' });
  ...
  const transactionLogFilterExists = MlFiltersCatalog.findOne({ moduleName: 'transactionLog' });
  ...
  const internalRequestFilterExists = MlFiltersCatalog.findOne({ moduleName: 'internalRequests' });
  ...
  const approvedRequestFilterExists = MlFiltersCatalog.findOne({ moduleName: 'internalApprovedRequests' });
  ...
  const processDocumentsFilterExists = MlFiltersCatalog.findOne({ moduleName: 'documents' });
  ...
  const templateAssignmentFilterExists = MlFiltersCatalog.findOne({ moduleName: 'templateAssignment' });
  ...
  // Office filter
  const officeFilterExists = MlFiltersCatalog.findOne({ moduleName: 'office' });
  ...
  // ProcessSetup Filter
  const processSetupFilterExists = MlFiltersCatalog.findOne({ moduleName: 'processSetup' });
  ...
  // Share Filter
  const shareFilterExists = MlFiltersCatalog.findOne({ moduleName: 'share' });
  ...
  const usersFilterExists = MlFiltersCatalog.findOne({ moduleName: 'users' });
  ...
  // Filter
  const auditFilterExists = MlFiltersCatalog.findOne({ moduleName: 'audit' });
  ...
  // Filter
  const serviceCardsFilterExists = MlFiltersCatalog.findOne({ moduleName: 'serviceCards' });
  ...
  const appointmentsFilterExists = MlFiltersCatalog.findOne({ moduleName: 'appointments' });
