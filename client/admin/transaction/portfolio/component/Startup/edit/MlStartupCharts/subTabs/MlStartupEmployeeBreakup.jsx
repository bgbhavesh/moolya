...
export default class MlStartupEmployeeBreakup extends React.Component {
  ...
  fetchDetails() {
    ...
    const empty = _.isEmpty(that.context.startupPortfolio && that.context.startupPortfolio.employeeBreakupDepartmentChart)
    if (empty) {
                      ...
                      <div className="form-group col-lg-6">
                        <div className="form-group col-md-6 col-sm-6">
                          <Datetime
                            dateFormat="YYYY" timeFormat={false} viewMode="years"
                            inputProps={{
                              placeholder: 'Select To Year', className: 'float-label form-control', readOnly: true, readOnly: true
                            }}
