...
render(){
    switch(this.state.componentToView){
      case 'createBeSpoke':
        return(<FunderCreateServicesView saveServiceDetails={this.saveServiceDetails.bind(this)} portfolioDetailsId={this.props.portfolioDetailsId}/>)
        break;
      case 'landingPage':
      ...
      case 'updateBeSpoke':
        return(
          <div className="app_main_wrap" style={{'overflow':'auto'}}>
            <div className="app_padding_wrap">
              <FunderCreateServicesView updateBeSpokeData={this.updateBeSpokeData.bind(this)}  beSpokeIndex={this.state.beSpokeIndex} beSpokeDetails={this.state.beSpokeServices}/>
            </div>
          </div>
        )
        break;
