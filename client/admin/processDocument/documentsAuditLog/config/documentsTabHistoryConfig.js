...
const mlDocumentsTabHistoryTableConfig = new MlViewer.View({
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'DOCUMENTS' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
