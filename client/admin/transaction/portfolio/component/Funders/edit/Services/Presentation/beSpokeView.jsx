...
export default class BeSpokeView extends Component {
  ...
  render() {
    ...
    const that = this;
    const attach = this.props.data && this.props.data.attachments ? this.props.data.attachments : [{}];
    const industryTypeQuery = gql`
    query{
                ...
                <form>
                  ...
                  <div className="form-group switch_wrap switch_names">
                    ...
                    <label className="switch nocolor-switch">
                      <input type="checkbox" name="mode" checked={this.props.data.mode !== 'online'} disabled={this.state.disableMode} onChange={e => this.props.modeSwitchHandler(e.target.checked, 'mode')} />
            ...
            <div className="col-md-6 nopadding-right">
              <div className="form_bg">
                <form>
                  <div className="form-group">
                    <Moolyaselect
                      multiSelect={true} className="form-control float-label" valueKey={'value'}
                  ...
                  <div className="form-group">
                    <Select
                      ...
                      disabled={this.props.data.mode !== 'online'}
                    ...
                    attach.map((details, index) => (
                      <div className="panel panel-default step5" key={index}>
                        ...
                        <div className="panel-body nopadding">
                          ...
                          {details.fileUrl ? details.fileUrl.map((image, id) => (
