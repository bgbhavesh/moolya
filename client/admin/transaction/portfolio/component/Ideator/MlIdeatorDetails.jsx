                ...
                <div className="form_bg">
                  <form>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="First Name" name="firstName" className="form-control float-label" id="cluster_name" defaultValue="Ravi" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Last Name" name="lastName" className="form-control float-label" id="cluster_name" defaultValue="Kapoor" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Gender" name="gender" className="form-control float-label" id="cluster_name" defaultValue="Male" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="DOB" name="dateOfBirth" className="form-control float-label" id="cluster_name" defaultValue="26-06-1980" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Education" name="qualification" className="form-control float-label" id="cluster_name" defaultValue="MSC, Mcom, Bcom" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Employment Status" name="employmentStatus" className="form-control float-label" id="cluster_name" defaultValue="Employeed" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Sector" name="professionalTag" className="form-control float-label" id="cluster_name" defaultValue="IT" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Employer Name" ref="employerName" className="form-control float-label" id="cluster_name" defaultValue="Mobiletech Solutions" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Years of Experience" name="yearsofExperience" className="form-control float-label" id="cluster_name" defaultValue="12" onBlur={this.handleBlur.bind(this)}/>
              ...
              >
                <div className="form_bg">
                  <form>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Phone No" name="mobileNumber" className="form-control float-label" id="cluster_name" defaultValue="9028728282" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Email Id" name="emailId" className="form-control float-label" id="cluster_name" defaultValue="abc@gmail.com" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Fcebook Id" name="facebookId" className="form-control float-label" id="cluster_name" defaultValue="abc@gmail.com" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Linkedin Id" ref="linkedInId" className="form-control float-label" id="cluster_name" defaultValue="abc@gmail.com" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Twitter Id" name="twitterId" className="form-control float-label" id="cluster_name" defaultValue="abc@gmail.com" onBlur={this.handleBlur.bind(this)}/>
                    ...
                    <div className="form-group">
                      <input type="text" placeholder="Googleplus Id" name="gplusId" className="form-control float-label" id="cluster_name" defaultValue="abc@gmail.com" onBlur={this.handleBlur.bind(this)}/>
