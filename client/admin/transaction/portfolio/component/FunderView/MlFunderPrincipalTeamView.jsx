                                    ...
                                    <div className="col-lg-9 col-md-9 col-sm-8">
                                      <div className="form_bg col-md-6">
                                        <form>
                                          ...
                                          <div className="form-group">
                                            <input type="text" placeholder="Name" className="form-control float-label" id="cluster_name" value={selectedPrincipal.firstName+" "+selectedPrincipal.lastName} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock" /><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedPrincipal.isFirstNamePrivate}/>
                                          </div>

                                          <div className="form-group">
                                            <input type="text" placeholder="Company" className="form-control float-label" id="cluster_name" value={selectedPrincipal.company?selectedPrincipal.company:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/>
                                          </div>
                                          <div className="form-group">
                                            <input type="text" placeholder="Year of Experience" className="form-control float-label" id="cluster_name" value={selectedPrincipal.yearsOfExperience?selectedPrincipal.yearsOfExperience:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedPrincipal.isYearsOfExperiencePrivate}/>
                                          </div>
                                      ...
                                      <div className="form_bg col-md-6">
                                        <form>
                                          ...
                                          <div className="form-group">
                                            <input type="text" placeholder="Disignation" className="form-control float-label" id="cluster_name" value={selectedPrincipal.designation?selectedPrincipal.designation:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedPrincipal.isDesignationPrivate}/>
                                          </div>

                                          <div className="form-group">
                                            <input type="text" placeholder="Duration" className="form-control float-label" id="cluster_name" value={selectedPrincipal.duration?selectedPrincipal.duration:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedPrincipal.isDurationPrivate}/>
                                          </div>
                                          <div className="form-group">
                                            <input type="text" placeholder="Qualification" className="form-control float-label" id="cluster_name" value={selectedPrincipal.qualification?selectedPrincipal.qualification:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedPrincipal.isQualificationPrivate}/>
                                          </div>
                                      ...
                                      <div className="form_bg col-md-12">
                                        <form>
                                          ...
                                          <div className="form-group">
                                            <input type="text" placeholder="About" className="form-control float-label" id="cluster_name" value={selectedPrincipal.aboutPrincipal?selectedPrincipal.aboutPrincipal:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedPrincipal.isAboutPrincipalPrivate}/>
                                          </div>
                                    ...
                                    <div className="col-lg-9 col-md-9 col-sm-8">
                                      <div className="form_bg col-md-6">
                                        <form>
                                          ...
                                          <div className="form-group">
                                            <input type="text" placeholder="Name" className="form-control float-label" id="cluster_name" value={selectedTeam.firstName+" "+selectedTeam.lastName} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock" /><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedTeam.isFirstNamePrivate}/>
                                          </div>

                                          <div className="form-group">
                                            <input type="text" placeholder="Company" className="form-control float-label" id="cluster_name" value={selectedTeam.company?selectedTeam.company:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/>
                                          </div>
                                          <div className="form-group">
                                            <input type="text" placeholder="Year of Experience" className="form-control float-label" id="cluster_name" value={selectedTeam.yearsOfExperience?selectedTeam.yearsOfExperience:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedTeam.isYearsOfExperiencePrivate}/>
                                          </div>
                                      ...
                                      <div className="form_bg col-md-6">
                                        <form>
                                          ...
                                          <div className="form-group">
                                            <input type="text" placeholder="Disignation" className="form-control float-label" id="cluster_name" value={selectedTeam.designation?selectedTeam.designation:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedTeam.isDesignationPrivate}/>
                                          </div>

                                          <div className="form-group">
                                            <input type="text" placeholder="Duration" className="form-control float-label" id="cluster_name" value={selectedTeam.duration?selectedTeam.duration:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedTeam.isDurationPrivate}/>
                                          </div>
                                          <div className="form-group">
                                            <input type="text" placeholder="Qualification" className="form-control float-label" id="cluster_name" value={selectedTeam.qualification?selectedTeam.qualification:""} disabled='disabled'/>
                                            <FontAwesome name='unlock' className="input_icon un_lock"/><input type="checkbox" className="lock_input" id="makePrivate" checked={selectedTeam.isQualificationPrivate}/>
                                          </div>
                                      ...
                                      <div className="form_bg col-md-12">
                                        <form>
                                          ...
                                          <div className="form-group">
                                            <input type="text" placeholder="About" className="form-control float-label" id="cluster_name" value={selectedTeam.aboutPrincipal?selectedTeam.aboutPrincipal:""} disabled='disabled'/>
