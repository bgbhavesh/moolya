...
export default class MlIdeatorDetails extends Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const empty = _.isEmpty(that.context.ideatorPortfolio && that.context.ideatorPortfolio.portfolioIdeatorDetails)
    if (empty) {
      if (response) {
  ...
  onFileUpload(file) {
    if (file) {
      const data = {
        moduleName: 'PORTFOLIO_PROFILE_IMG', actionName: 'UPDATE', portfolioId: this.props.portfolioDetailsId, communityType: 'IDE', portfolio: { portfolioIdeatorDetails: { profilePic: ' ' } }
      };
                ...
                <div className="col-md-6 nopadding-left">
                  ...
                  <div className="form_bg">
                    <form id="ideatorDetails">
                      ...
                      <div className="form-group mandatory">
                        <input
                          type="text" placeholder="Last Name" name="lastName" defaultValue={this.state.data.lastName}
                          ref="lastName"
