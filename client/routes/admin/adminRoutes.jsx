  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'registrations', subModule: 'approved'
        }} />,
      adminContent: <MlRegistrtionApprovedList/>
    })
  }
});
...
adminSection.route('/transactions/registrationRequested', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'registrations', subModule: 'requested'
        }} />,
      adminContent: <MlRequestedList/>
    })
  }
});
...
adminSection.route('/transactions/editRequests/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'registrations', subModule: 'requested', transactionsRegistrations: 'registrationRequested'
        }} />,
      adminContent: <RegistrationWizard config={params.id}/>
    })
  }
});
adminSection.route('/transactions/editApprovedRequests/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'registrations', subModule: 'approved', transactionsRegistrations: 'registrationApprovedList'
        }} />,
      adminContent: <RegistrationWizard config={params.id}/>
    })
  }
...
adminSection.route('/transactions/createRegistration', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'registrations', subModule: 'create'
        }} />,
      adminContent: <MlCreateRegistration/>
    })
  }
});
...
adminSection.route('/transactions/rejectedRegistrations', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'registrations', subModule: 'reject'
        }} />,
      adminContent: <MlRegistrationRejectedList/>
    })
  }
});
...
adminSection.route('/transactions/registrationHistory', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'registrations', subModule: 'history'
        }} />,
      adminContent: <MlRegistrationTabHistoryList/>
    })
  }
});
// ************* Portfolio Routes **************
adminSection.route('/transactions/portfolio/requestedPortfolioList', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'portfolio', subModule: 'requested'
        }} />,
      adminContent: <MlRequestedPortfolioList/>
    })
  }
});
adminSection.route('/transactions/portfolio/approvedPortfolioList', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'portfolio', subModule: 'approved'
        }} />,
      adminContent: <MlApprovedPortfolioList/>
    })
  }
});
...
adminSection.route('/transactions/portfolio/history', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'portfolio', subModule: 'history'
        }} />,
      adminContent: <MlPotfolioTabHistoryList/>
    })
  }
});
...
adminSection.route('/transactions/portfolio/editRequests/:id/:communityType', {
  ...
  action(params) {
    ...
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'portfolio', subModule: 'edit'
        }} />,
      adminContent: <MlPortfolio viewMode={false} config={params.id} communityType={params.communityType}/>
    })
  }
});
...
adminSection.route('/transactions/portfolio/viewPortfolio/:id/:communityType', {
  ...
  action(params) {
    ...
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'transaction', showBreadCrum: true, module: 'portfolio', subModule: 'view'
        }} />,
      adminContent: <MlPortfolio viewMode={true} config={params.id} communityType={params.communityType}/>
    })
  }
});
...
adminSection.route('/templates/assignTemplate/', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'templates', showBreadCrum: true, module: 'template', subModule: 'Add'
        }} />,
      adminContent: <MlAssignTemplate />
    })
  }
});
...
adminSection.route('/templates/assignTemplate/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'templates', showBreadCrum: true, module: 'template', subModule: 'Edit'
        }} />,
      adminContent: <MlEditAssignTemplate config={params.id} />
    })
  }
});
