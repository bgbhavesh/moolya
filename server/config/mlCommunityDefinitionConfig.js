...
const communityDef = [{
  _id: 'ideators', name: 'Ideators', code: 'IDE', displayName: 'Ideators', showOnMap: false, aboutCommunity: 'Ideator', communityImageLink: 'ml my-ml-Ideator', isActive: true
},
{
...
Meteor.startup(() => {
  for (let i = 0; i < communityDef.length; i++) {
    const communityDefinition = MlCommunityDefinition.findOne({ code: communityDef[i].code });
