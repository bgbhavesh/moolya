...
class MlStartupClients extends Component {
  ...
  componentWillMount() {
    const empty = _.isEmpty(this.context.startupPortfolio && this.context.startupPortfolio.clients)
    if (!empty) {
  ...
  onTileSelect(index, uiIndex, e) {
    const cloneArray = _.cloneDeep(this.state.startupClients);
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.startupClients
  ...
  sendDataToParent(isSaveClicked) {
    ...
    const clients = this.state.startupClients;
  ...
  async fetchOnlyImages() {
    ...
    if (response && response.clients) {
      ...
      const dataDetails = this.state.startupClients
  ...
  render() {
    let companyNameActive = '',
      clientDescriptionActive = ''
    ...
    const clientsArray = that.state.startupClientsList || [];
