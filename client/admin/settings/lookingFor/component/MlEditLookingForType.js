...
class MlEditLookingForType extends React.Component {
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/settings/registration/lookingForList'); } else { toastr.error(response.result); }
    }
  }

  async findLookingForType() {
    const LookingForTypeId = this.props.config
              ...
              <div className="form_bg">
                <form>
                  <div className="form-group mandatory">
                    ...
                    <input
                      type="text" ref="lookingForName" placeholder="Name" defaultValue={this.state.data && this.state.data.lookingForName}
            ...
            <div className="col-md-6 nopadding-right">
              <div className="form_bg">
                <form>
                  <div className="form-group mandatory">
                    <input
                      type="text" ref="lookingForDisplayName" placeholder="Display Name"
                  ...
                  <Moolyaselect
                    multiSelect={false} placeholder="Select Community" mandatory={true} className="form-control float-label" valueKey={'value'}
