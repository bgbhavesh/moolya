...
export default class MlCompanyViewServicesAndProducts extends Component {
  constructor(props) {
    super(props);
    this.state={
      view:{},
  ...
  async createAnnotations(annotation){
    let details = {portfolioId:this.props.portfolioDetailsId, docId:"companyServicesAndProducts", quote:JSON.stringify(annotation)}
  ...
  async fetchAnnotations(isCreate){
    const response = await findAnnotations(this.props.portfolioDetailsId, "companyServicesAndProducts");
          ...
          <div className="panel-form-view">
            <div className="panel panel-default">
                <div className="panel-heading hide_unlock">
                  Service & Products
                    <FontAwesome name='unlock' className="input_icon req_header_icon un_lock" id="isSPDescriptionPrivate" />
                </div>
