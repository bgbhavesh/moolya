...
const mlTransactionTabHistoryTableConfig = new MlViewer.View({
  name: 'auditLogTable',
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'SHAREDLIBRARY,REQUESTTYPE,CONVERSATIONS,TRANSACTIONTYPE,OFFICE,PROCESSSETUP,INTERNALREQUESTS' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
...
export { mlTransactionTabHistoryTableConfig };
