  ...
  getTabComponents() {
    const tabs = [
      ...
      },
      {
        ...
        panelClassName: 'panel',
        title: 'Investor',
        component: <MlInstitutionEditInvestor
          client={client} key="3" getInvestorDetails={this.getInvestorDetails.bind(this)}
      ...
      },
      {
        ...
        component: <MlInstitutionEditData
          key="4" getDataDetails={this.getDataDetails.bind(this)} isAdmin={true}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        panelClassName: 'panel',
        title: 'Charts',
        component: <MlInstitutionEditChart
          key="5" getInvestorDetails={this.getInvestorDetails.bind(this)}
      ...
      }, //
      {
        ...
        panelClassName: 'panel',
        title: 'M C & L',
        component: <MlInstitutionEditMCL
      ...
      },
      {
        ...
        panelClassName: 'panel',
        title: 'Looking For',
        component: <MlInstitutionEditLookingFor
      ...
      },
      {
        ...
        component: <MlInstitutionEditPartners
          key="10" getPartnersDetails={this.getPartnersDetails.bind(this)} client={client}
      ...
      },
      {
        ...
        component: <MlInstitutionCSREditTabs
          key="11" getCSRDetails={this.getCSRDetails.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}
          backClickHandler={this.backClickHandler.bind(this)}/>
      },
      {
        ...
        panelClassName: 'panel',
        title: 'R&D',
        component: <MlInstitutionEditRD
          key="12" getRDDetails={this.getRDDetails.bind(this)} client={client}
      ...
      },
      {
        ...
        panelClassName: 'panel',
        title: 'Incubators',
        component: <MlInstitutionIncubatorsEditTabs
          key="13" getIncubators={this.getIncubators.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}
          backClickHandler={this.backClickHandler.bind(this)}/>
      },
      {
        ...
        panelClassName: 'panel',
        title: 'Intrapreneur',
        component: <MlInstitutionEditIntrapreneur
