...
export default class MlStartupViewAssets extends React.Component {
  ...
  async createAnnotations(annotation){
    let details = {portfolioId:this.props.portfolioDetailsId, docId:"startupAssets", quote:JSON.stringify(annotation)}
    ...
    return (
      <div id="annotatorContent">
          ...
          <div className="col-lg-12">
            <div className="row">
              {branchesArray && branchesArray.assets && branchesArray.assets.map(function (details, idx) {
