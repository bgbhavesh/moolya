...
export default class MlAppFunderEditTabs extends Component {
  constructor(props) {
    super(props)
    this.state = {
      tabs: [], aboutUs: {}, funderPortfolio: {}, portfolioKeys: { privateKeys: [], removePrivateKeys: [] }, activeTab: 'About'
    };
    ...
    const tabs = [
      {
        ...
        title: 'About',
        name: 'About',
        component: <MlFunderAbout
          client={appClient} tabName="funderAbout" isAdmin={false} key="1"
      ...
      },
      {
        ...
        title: 'Investments',
        name: 'Investments',
        component: <MlFunderInvestment
          client={appClient} isAdmin={false} key="2" tabName="investments"
      ...
      },
      {
        ...
        component: <MlFunderPrincipalTeam
      ...
      },
      {
        ...
        component: <MlFunderEngagementMethod
          client={appClient} isAdmin={false} key="4"
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        component: <MlFunderAreaOfInterest
      ...
      },
      {
        ...
        component: <MlFunderSuccessStories
          client={appClient} isAdmin={false} key="7" tabName="successStories"
      ...
      },
      {
        ...
        component: <PortfolioLibrary
          client={appClient} isAdmin={false} key="8"
      ...
      },
      {
        ...
        title: 'News',
        name: 'News',
        component: <MlFunderNews
          client={appClient} isAdmin={false} key="9"
      ...
      },
      {
        ...
        title: 'Looking For',
        name: 'Looking For',
        component: <MlFunderLookingFor
          key="8" getLookingFor={this.getLookingFor.bind(this)} tabName="lookingFor"
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        title: 'Services',
        name: 'Services',
        component: <MlFunderServices
          myPortfolio={true} createServiceMode={true} client={appClient} isAdmin={false}
  ...
  getLookingFor(details, privateKey, requiredFields) {
    const data = this.state.funderPortfolio;
  ...
  getServiceDetails(details, privatekey) {
    if (details.services) {
      const portfolioId = details.portfolioId;
