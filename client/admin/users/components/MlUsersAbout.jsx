...
export default class MlUsersAbout extends Component {
  ...
  async findRegistration() {
    const registrationId = this.props.config ? this.props.config.registrationId : '';
  ...
  async changeUrl(registrationId) {
    ...
    if (response && response.portfolioId) {
      ...
      FlowRouter.setParams({ registrationId, portfolioId: response.portfolioId })
    } else {
  ...
  async onStatusChange(e, userprofile) {
    ...
    if (response && response.result && response.success) { toastr.success(response.result) } else if (response && response.result && !response.success) { toastr.error(response.result) }
  }
  ...
  async overUserStatus(e) {
    ...
    const regInfo = this.state.data && this.state.data.registrationInfo ? this.state.data.registrationInfo : {}
  ...
  componentDidUpdate() {
    ...
    this.initializeSwiper();
    const logedAdmin = this.loggedUserDetails
  ...
  render() {
    ...
    const userTypequery = gql` query($communityCode:String){  
    ...
    const that = this;
    const regInfo = this.state.data && this.state.data.registrationInfo ? this.state.data.registrationInfo : {}
    const regDetail = this.state.data && this.state.data.registrationDetails ? this.state.data.registrationDetails : {}
    const alsoRegisterAs = this.state.data && this.state.data.externalUserProfiles && this.state.data.externalUserProfiles.length > 0 ? this.state.data.externalUserProfiles : ['0']
    const showLoader = this.state.loading;
    const userTypeOption = { options: { variables: { communityCode: regInfo.registrationType } } };
    const professionQueryOptions = { options: { variables: { industryId: regInfo.industry } } };
    const employmentOption = { options: { variables: { type: 'EMPLOYMENTTYPE', hierarchyRefId: regInfo.clusterId } } };
    const titleOption = { options: { variables: { type: 'TITLE', hierarchyRefId: regInfo.clusterId } } };
    const chapterOption = { options: { variables: { id: regInfo.clusterId } } };
    const genderImage = regDetail.gender === 'female' ? '/images/female.jpg' : '/images/ideator_01.png';
    const { userProfileImage } = this.state.data;
    const profileImage = userProfileImage || regInfo.profileImage;
    return (
                  ...
                  <div className="form_bg">
                    <form>
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Moolya Id" name="moolyaId"
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="First Name" name="firstName" defaultValue={regInfo.firstName}
                          className="form-control float-label" disabled="disabled"/>
                      </div>

                      <div className="form-group">
                        <input
                          type="text" placeholder="Last Name" name="lastName" defaultValue={regInfo.lastName}
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Username" name="username" defaultValue={regInfo.userName}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      ...
                      <div className="form-group">
                        <input
                          type="password" placeholder="Password" name="password" defaultValue={'passwordUnSeen'}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      <div className="form-group">
                        <input
                          type="text" placeholder="Date of Birth" name="dob" defaultValue={regDetail.dateOfBirth}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      <div className="form-group">
                        <input
                          type="text" placeholder="Gender" name="gender" defaultValue={regDetail.gender}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      ...
                      <div className="form-group">
                        ...
                        {/* disabled="disabled"/> */}
                        <Moolyaselect
                          multiSelect={false} placeholder="Select Profession"
                      ...
                      <div className="form-group">
                        ...
                        {/* disabled="disabled"/> */}
                        <Moolyaselect
                          multiSelect={false} placeholder="Employment Status"
                          className="form-control float-label" valueKey={'value'} labelKey={'label'}
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Employer Name" defaultValue={regDetail.employerName}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      <div className="form-group">
                        <input
                          type="text" placeholder="Employer URL" defaultValue={regDetail.employerWebsite}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      <div className="form-group">
                        <input
                          type="text" placeholder="Employment Date" defaultValue={regDetail.employmentDate}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      {/* <div className="form-group"> */}
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Profession Tag" defaultValue={regDetail.professionalTag}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      <div className="form-group">
                        <input
                          type="text" placeholder="Identity" defaultValue={regInfo.identityType}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      <div className="form-group">
                        ...
                        {/* disabled="disabled"/> */}
                        <Moolyaselect
                          multiSelect={false} placeholder="Select User Category"
                          className="form-control float-label" valueKey={'value'} labelKey={'label'}
                ...
                >
                  <div className="form_bg">
                    <form>
                      ...
                      <Moolyaselect
                        type="text" placeholder="Your City" className="form-control float-label"
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Email Id" defaultValue={regInfo.email}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Phone Number" defaultValue={regInfo.contactNumber}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Subscription Type" defaultValue={regInfo.accountType}
                          className="form-control float-label"
                          disabled="disabled"/>
                      </div>
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Do you want to associate"
                      ...
                      <div className="form-group">
                        ...
                        {/* className="form-control float-label" disabled="disabled"/> */}
                        <Moolyaselect
                          multiSelect={true} placeholder="Select Citizenship"
                          className="form-control float-label" valueKey={'value'} labelKey={'label'}
                      ...
                      <div className="form-group">
                        <input
                          type="text" placeholder="Qualification" defaultValue={regDetail.qualification}
                          className="form-control float-label" disabled="disabled"/>
                      </div>
                      ...
                      <div className="form-group">
                        ...
                        {/* className="form-control float-label" disabled="disabled"/> */}
                        <Moolyaselect
                          multiSelect={false} placeholder="Select Cluster"
                          className="form-control float-label" valueKey={'value'} labelKey={'label'}
                      ...
                      <div className="form-group">
                        ...
                        {/* className="form-control float-label" disabled="disabled"/> */}
                        <Moolyaselect
                          multiSelect={false} placeholder="Select Chapter"
                          className="form-control float-label" valueKey={'value'} labelKey={'label'}
                      ...
                      <div className="swiper-container blocks_in_form">
                        ...
                        <div className="swiper-wrapper">
                          {alsoRegisterAs.map((userProfile, id) => (
                            <div className="form_inner_block swiper-slide" key={id}>
                              <div onClick={e => that.handleSwiperClick(e, userProfile.registrationId)}>
                                <div className="form-group">
                                  <input
                                    type="text" placeholder="Community" defaultValue={userProfile.communityName}
                                    className="form-control float-label" disabled="disabled"/>
                                </div>
                                <div className="form-group left_al">
                                  <input
                                    type="text" placeholder="Identity" defaultValue={userProfile.identityType}
                                    className="form-control float-label" disabled="disabled"/>
                                </div>
                                <div className="form-group right_al">
                                  <input
                                    type="text" placeholder="Type" className="form-control float-label"
                                    disabled="disabled"/>
                                </div>
                                <div className="form-group left_al">
                                  <input
                                    type="text" placeholder="Cluster" className="form-control float-label"
                                    defaultValue={userProfile.clusterName} disabled="disabled"/>
                                </div>
                                <div className="form-group right_al">
                                  <input
                                    type="text" placeholder="Chapter" className="form-control float-label"
                                    defaultValue={userProfile.chapterName} disabled="disabled"/>
                                </div>
                                <div className="form-group left_al">
                                  <input
                                    type="text" placeholder="Sub-Chapter" className="form-control float-label"
                                    defaultValue={userProfile.subChapterName} disabled="disabled"/>
                                </div>
                                <div className="form-group right_al">
                                  <input
                                    type="text" placeholder="Subscription Type"
                                    className="form-control float-label"
                              ...
                              <div className="form-group switch_wrap">
                                ...
                                <label className="switch">
                                  <input
                                    type="checkbox" onChange={e => that.onStatusChange(e, userProfile)}
                      ...
                      <div className="form-group switch_wrap inline_switch">
                        ...
                        <label className="switch">
                          <input
                            type="checkbox" id="overAllStatus" onChange={e => that.overUserStatus(e)}
                      ...
                      <div className="form-group switch_wrap">
                        ...
                        <label className="switch">
                          <input
                            type="checkbox" onChange={e => that.overMapStatusChange(e)}
