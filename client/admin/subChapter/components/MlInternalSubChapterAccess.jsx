...
export default class MlInternalSubChapterAccess extends React.Component {
  ...
  componentWillMount() {
    if (!isEmpty(this.props.assignedDetails)) {
      const userState = this.props.assignedDetails
  ...
  getSelectedTab(type, index, event) {
    const availabilityDetails = this.state.data
  ...
  selectAssociateChapter(index, val, callback, label) {
    const chapterId = label && label.chapterId ? label.chapterId : null
    const availabilityDetails = this.state.data
    const value = val || null
    const obj = [{ subChapterId: value, chapterId }]
  ...
  render() {
    ...
    const subChapterQuery = gql`query($subChapterId:String){data:fetchSubChaptersSelectNonMoolya(subChapterId:$subChapterId) { value:_id, label:subChapterName, chapterId:chapterId}}`;
    const subChapterOption = { options: { variables: { subChapterId: this.props.curSubChapter } } };
    return (
      <div >
              ...
              <div className="panel-body">
                <div className="ml_tabs">
                  <div className="form-group">
                    <Moolyaselect
                      multiSelect={false} placeholder="Related Sub-Chapters" disabled={value.disabled}
                        ...
                        <div className="row">
                          <div className="col-md-4">
                            <div className="form-group switch_wrap inline_switch">
                              ...
                              <label className="switch">
                                <input
                                  type="checkbox" ref="canSearchB" checked={value.backendUser.canSearch}
                          ...
                          <div className="col-md-4">
                            <div className="form-group switch_wrap inline_switch">
                              ...
                              <label className="switch">
                                <input
                                  type="checkbox" ref="canViewB" checked={value.backendUser.canView}
                          ...
                          <div className="col-md-4">
                            <div className="form-group switch_wrap inline_switch">
                              ...
                              <label className="switch">
                                <input
                                  type="checkbox" ref="canTransactB" checked={value.backendUser.canTransact}
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-4">
                            <div className="form-group switch_wrap inline_switch">
                              ...
                              <label className="switch">
                                <input
                                  type="checkbox" ref="canTransactE"
