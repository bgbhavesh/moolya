...
export default class MlAppFunderIndividualComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
                ...
                <div>
                  ...
                  <div className="form-group">
                    <input type="text" ref="firstName"
                           ...
                           placeholder="First Name" className="form-control float-label" id=""/>
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    <input type="text" ref="lastName"
                           ...
                           placeholder="Last Name" className="form-control float-label" id=""/>
                  </div>
                  <div className="form-group">
                    ...
                    <div className="panel-body">
                      <div className="form-group">
                        <Moolyaselect multiSelect={false} placeholder="Select Currency"
                                      ...
                                      queryOptions={genderOption} onSelect={that.optionsBySelectCurrency.bind(that)}
                                      isDynamic={true}/>
                      </div>
                      <div className="form-group">
              ...
              <form>
                ...
                <div className="form-group" id="date-time">
                  <Datetime dateFormat="DD-MM-YYYY" timeFormat={false} inputProps={{placeholder: "Employment Date",readOnly:true}}
                            closeOnSelect={true} value={that.state.employmentDate} isValidDate={ valid }
