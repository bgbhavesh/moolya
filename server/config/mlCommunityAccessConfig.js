...
Meteor.startup(() => {
  for (let i = 0; i < communityAccess.length; i++) {
    const communityAccessRec = MlCommunityAccess.findOne({ communityDefCode: communityAccess[i].communityDefCode, platformId: 'Admin' });
