...
class MlEditSubDepartment extends React.Component {
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/settings/subDepartmentsList'); } else { toastr.error(response.result); }
                  ...
                  <div className="form_bg">
                    <form>
                      <div className="form-group mandatory">
                        <input
                          type="text" ref="subDepartmentName"
                      ...
                      <div className="form-group switch_wrap inline_switch">
                        ...
                        <label className="switch">
                          <input
                            type="checkbox" ref="subDepartmentStatus"
                      ...
                      {this.state.data != '' && (<div>
                        <div className="form-group switch_wrap switch_names" disabled="true">
                          ...
                          <span className="state_label acLabel">EcoSystem</span><label className="switch">
                            <input
                              type="checkbox" ref="appType" checked={this.state.data && !this.state.data.isMoolya}
                              disabled="true"/>
                            <div className="slider"></div>
                          </label>
