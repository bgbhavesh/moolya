...
export default class MlIdeatorPortfolioEditTabs extends Component {
  constructor(props) {
    super(props)
    this.state = {
      tabs: [], ideatorPortfolio: {}, idea: {}, portfolioKeys: { privateKeys: [], removePrivateKeys: [] }
    };
    ...
    const tabs = [
      {
        ...
        title: 'Ideas',
        component: <MlIdeatorIdeas
          tabName="ideas" key="2" getIdeas={this.getIdeas.bind(this)}
      ...
      },
      {
        ...
        panelClassName: 'panel',
        title: 'Ideator',
        component: <MlIdeatorDetails
          key="1" tabName="portfolioIdeatorDetails" client={client} isAdmin={true}
      ...
      },
      {
        ...
        component: <MlIdeatorProblemsAndSolutions
          tabName="problemSolution" client={client} isAdmin={true}
      ...
      },
      {
        ...
        panelClassName: 'panel',
        title: 'Audience',
        component: <MlIdeatorAudience
          key="4" client={client} tabName="audience" isAdmin={true}
      ...
      },
      {
        ...
        component: <PortfolioLibrary
          client={client} isAdmin={true} tabName="Library" key="5"
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        component: <MlIdeatorStrategyAndPlanning
          key="6" tabName="strategyAndPlanning"
      ...
      },
      {
        ...
        component: <MlIdeatorIntellectualPlanningAndTrademark
          key="7" tabName="intellectualPlanning"
  ...
  getIdeatorDetails(details, privateKey, requiredFields) {
    const data = this.state.ideatorPortfolio;
  ...
  getIdeas(details, privateKey, requiredFields) {
    ...
    const updateItem = _.omit(data, 'ideaImage');
