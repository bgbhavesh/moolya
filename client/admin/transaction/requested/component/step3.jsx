...
export default class Step3 extends React.Component {
  ...
  isUpdated() {
    const contactDetailsValidate = this.refs.contactDetailsComponent.isValidate()
    const emailDetailsValidate = this.refs.emailDetailsComponent.isValidate()
    const addressDetailsValidate = this.refs.addressDetailsComponent.isValidate()
