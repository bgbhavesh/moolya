...
!function () {
  ...
  Delegator = (function () {
    ...
    Delegator.prototype._addEvent = function (selector, event, functionName) {
      ...
      closure = (function (_this) {
        return function () {
          return _this[functionName](...arguments)
        }
      }(this));
  ...
  Delegator._parseEvents = function (eventsObj) {
    ...
    for (sel in eventsObj) {
      ...
      _ref1 = sel.split(' '), selector = _ref1.length >= 2 ? __slice.call(_ref1, 0, _k = _ref1.length - 1) : (_k = 0, []), event = _ref1[_k++];
      events.push({
  ...
  Range.NormalizedRange = (function () {
    ...
    NormalizedRange.prototype.limit = function (bounds) {
      let nodes,
        ...
        _len2,
        _ref1;
      nodes = $.grep(this.textNodes(), node => node.parentNode === bounds || $.contains(bounds, node.parentNode));
      if (!nodes.length) {
        return null
      }
      this.start = nodes[0];
  ...
  Annotator = (function (_super) {
    ...
    Annotator.prototype.html = {
      adder: `<div class="annotator-adder"><i class="fa fa-pencil" aria-hidden="true"></i><button>${_t('Annotate')}</button></div>`,
      ...
      if (!selection.isCollapsed) {
        ranges = function () {
          let _k,
            ...
            _results;
          _results = [];
          for (i = _k = 0, _ref1 = selection.rangeCount; _ref1 >= 0 ? _k < _ref1 : _k > _ref1; i = _ref1 >= 0 ? ++_k : --_k) {
  ...
  $.fn.annotator = function (options) {
    ...
    return this.each(function () {
      ...
      if (instance) {
        return options && instance[options](...args)
      }
      ...
      onMousemove = (function (_this) {
        return function (event) {
          ...
          if (mousedown && throttle === false) {
            ...
            throttle = true;
            return setTimeout(() => throttle = false, 1e3 / 60)
          }
        }
      }(this));
  ...
  LinkParser = (function () {
    ...
    LinkParser.prototype.get = function (rel, cond) {
      ...
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        d = _ref2[_k];
        match = keys.reduce((m, k) => m && d[k] === cond[k], true);
        if (match) {
          _results.push(d)
        } else {
          continue
