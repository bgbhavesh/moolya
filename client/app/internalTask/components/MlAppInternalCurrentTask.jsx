              ...
              <div className="row">
                <div className="col-lg-2 col-md-4 col-sm-4">
                  <div className="list_block list_block_intrests notrans">
                    ...
                    <h3><span className="pull-left"> Asses</span> <span className="pull-right badge ml_badge_red">0%</span> </h3>
                  </div>
                </div>
                <div className="col-lg-2 col-md-4 col-sm-4">
                  <div className="list_block list_block_intrests notrans">
                    <div className="hex_outer"><img src="/images/document.png"/></div>
                    <h3><span className="pull-left"> Discuss</span> <span className="pull-right badge ml_badge_red">10%</span> </h3>
                  </div>
                </div>
                <div className="col-lg-2 col-md-4 col-sm-4">
                  <div className="list_block list_block_intrests notrans">
                  ...
                  <div className="col-md-6">
                    <div className="form_bg">
                      ...
                      <div className="form-group ml_btn">
                        <a href="/app/appOfficeBearerUpcomingTasksEdit" className="cancel_btn">Start</a>
                      </div>
                    </div>
                  </div>
                </div>
