...
appSection.route('/dashboard/:isFirst', {
  name: 'dashboard',
  action(params) {
    mount(AppLayout, { appContent: <MlViews showInfinity={true} mapConfig={mlAppClusterDashboardMapConfig} listConfig={mlAppClusterDashboardListConfig}/>, isFirst: (params.isFirst == 'true') })
...
appSection.route('/dashboard/:clusterId/chapters', {
  ...
  action(params, queryParams) {
    ...
    mount(AppLayout, {
      appContent: <MlViews
        viewMode={viewMode} showInfinity={true} mapConfig={mlAppChapterDashboardMapConfig}
...
appSection.route('/dashboard/:clusterId/:chapterId/subChapters', {
  ...
  action(params, queryParams) {
    ...
    mount(AppLayout, {
      appContent: <MlViews
        viewMode={viewMode} showInfinity={true} mapConfig={mlAppSubChapterDashboardMapConfig}
...
appSection.route('/dashboard/:clusterId/:chapterId/:subChapterId/communities', {
  ...
  action(params, queryParams) {
    ...
    mount(AppLayout, {
      appContent: <MlViews
        viewMode={viewMode} showInfinity={true} mapConfig={mlDashboardMapConfig}
...
appSection.route('/dashboard/:clusterId/:chapterId/:subChapterId/anchorInfoView', {
  ...
  action(params, queryParams) {
    mount(AppLayout, {
      appContent: <MlAnchorInfoView
        subChapterId={params.subChapterId} clusterId={params.clusterId}
...
appSection.route('/ideator', {
  name: 'ideator',
  action() {
    const listConfig = _.extend(mlAppIdeatorConfig, { isExplore: false });
    mount(AppLayout, {
      appContent:
...
appSection.route('/startup', {
  ...
  action() {
    ...
    const listConfig = _.extend(mlAppStartupConfig, { isExplore: false });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/serviceProvider', {
  name: 'provider',
  action() {
    const listConfig = _.extend(mlAppServiceProviderConfig, { isExplore: false });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/explore/institution', {
  name: 'explore',
  action() {
    const listConfig = _.extend(mlAppInstitutionConfig, { isExplore: true });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/institution', {
  name: 'institutions',
  action() {
    const listConfig = _.extend(mlAppInstitutionConfig, { isExplore: false });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/explore/company', {
  name: 'explore',
  action() {
    const listConfig = _.extend(mlAppCompanyConfig, { isExplore: true });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/company', {
  name: 'company',
  action() {
    const listConfig = _.extend(mlAppCompanyConfig, { isExplore: false });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/funder', {
  name: 'funder',
  action() {
    const config = _.extend(mlAppFunderConfig2, { isExplore: false });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
...
appSection.route('/explore/ideator/', {
  ...
  action(params) {
    ...
    const listConfig = _.extend(mlAppIdeatorConfig, { isExplore: true });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/explore/investor', {
  ...
  action() {
    ...
    // mount(AppLayout,{appContent:<MlViews viewMode={false} showInfinity={false} listConfig={listConfig} />})
    const listConfig = _.extend(mlAppFunderConfig2, { isExplore: true });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/explore/serviceProvider', {
  name: 'explore',
  action() {
    const listConfig = _.extend(mlAppServiceProviderConfig, { isExplore: true });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
...
appSection.route('/explore/startup', {
  name: 'explore',
  action() {
    const listConfig = _.extend(mlAppStartupConfig, { isExplore: true });
    mount(AppLayout, {
      appContent:
      (<div className="app_main_wrap">
        <MlInfiniteScroll viewMode={false} showInfinity={false} config={listConfig} />
