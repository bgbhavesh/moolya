...
export default class DocumentViewer extends React.Component {
  ...
  showModal(index) {
    const data = this.props.doc && this.props.doc.docFiles ? this.props.doc.docFiles : []
    let imagePreviewUrl;
  ...
  render() {
    const selectedDocs = this.props.selectedDocuments;
    const url = this.state.previewImage;
    let fileType = 'image';
        ...
        <div className="panel panel-default uploaded_files">
          ...
          <div className="panel-body uploaded_files_swiper">
            ...
            <ul className="swiper-wrapper">
              ...
              {docFiles.map((file, fIndex) => (<li key={file.fileId} className="doc_card" data-toggle="modal" data-placement="bottom" title={file.fileName}>
