...
export default class MlInstitutionViewEvolution extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'institutionEvolution', quote: JSON.stringify(annotation) }
  ...
  async fetchAnnotations(isCreate) {
    const response = await findAnnotations(this.props.portfolioDetailsId, 'institutionEvolution');
