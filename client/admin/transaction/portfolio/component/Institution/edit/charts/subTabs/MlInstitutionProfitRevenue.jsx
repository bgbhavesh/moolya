...
export default class MlInstitutionProfitRevenue extends React.Component {
  ...
  onSaveAction(index, e) {
    ...
    const clients = this.state.startupCompanyRevenue;
    clients[index] = data
    this.setState({ startupCompanyRevenue: clients })
    this.props.getStartupProfitRevenue(clients);
  ...
  fetchDetails() {
    ...
    const empty = _.isEmpty(that.context.institutionPortfolio && that.context.institutionPortfolio.profitRevenueLiabilityChart)
    if (empty) {
      this.setState({ loading: false, startupCompanyRevenue: that.props.revenueDetails, revenuList: that.props.revenueDetails });
    } else {
      this.setState({ loading: false, startupCompanyRevenue: that.context.institutionPortfolio.profitRevenueLiabilityChart, revenuList: that.context.institutionPortfolio.profitRevenueLiabilityChart });
    }
  }
  ...
  optionsBySelectTypeOfEntity(index, val) {
    ...
    const revenueArray = this.state.revenuList;
    this.setState({ data: details }, function () {
  ...
  render() {
    const that = this;
    const revenueArray = this.state.revenuList && this.state.revenuList.length > 0 ? this.state.revenuList : []
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-10">
                    <div className="row">
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        ...
                        <Select
                          name="form-field-name" placeholder="Select Value Type" options={entityTypes}
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        ...
                        <Select
                          name="form-field-name" placeholder="Select Value Type" options={valueTypes}
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <input
                          type="text" placeholder="Value" ref={`prlValue${defaultIndex}`} className="form-control float-label"
                          id="" name="prlValue" onBlur={this.valueHandleBlur.bind(this, defaultIndex)}/>
                      </div>

                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <textarea
                          rows="1" placeholder="About" ref={`prlabout${defaultIndex}`} className="form-control float-label"
                          id="" name="prlabout" onBlur={this.aboutHandleBlur.bind(this, defaultIndex)}></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                {that.state.revenuList.map((details, idx) => (<div className="form_inner_block">
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-10">
                    <div className="row">
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <input
                          type="text" placeholder="Value" ref={`prlValue${idx}`} className="form-control float-label"
                          id="" defaultValue={details.prlValue} name="prlValue" onBlur={that.valueHandleBlur.bind(that, idx)}/>
                      </div>

                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <textarea
                          rows="1" placeholder="About" ref={`prlabout${idx}`} className="form-control float-label"
...
MlInstitutionProfitRevenue.contextTypes = {
