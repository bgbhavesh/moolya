            ...
            <form>
                ...
                <div className="input_types">
                  ...
                  <label htmlFor="percent"><span><span></span></span>
                    Percentage{servicePayment.discountType === 'percent' ?
                      <input
                        className="form-control inline_input" onChange={event => calculateDiscounts(event)}
              ...
              <div className="form-group switch_wrap switch_names inline_switch">
                ...
                <label htmlFor="isApprovalRequiredFromSeeker" className="switch nocolor-switch">
                  <input
                    id="isApprovalRequiredFromSeeker" type="checkbox" checked={!servicePayment.isApprovalRequiredFromSeeker}
              ...
              <div className="form-group">
                ...
                <div className="input_types">
                  <input
                    id="facilitationamount" type="radio" name="facilitationamount"
              ...
              <div className="form-group">
                <label>Net payable amount&nbsp;<label>{servicePayment.currencyType ? servicePayment.currencyType : this.state.currencySymbol}</label>&nbsp;<input
