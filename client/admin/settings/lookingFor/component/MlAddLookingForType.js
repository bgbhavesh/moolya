            ...
            <div className="col-md-6 nopadding-left">
              <div className="form_bg">
                <form>
                  ...
                  <Moolyaselect
                    multiSelect={false} ref="community" className="form-control float-label" mandatory={true} valueKey={'value'}
            ...
            <div className="col-md-6 nopadding-right">
              <div className="form_bg">
                <form>
                  <div className="form-group mandatory">
                    <input
                      type="text" ref="lookingForName" placeholder="Looking For Name"
