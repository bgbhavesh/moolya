...
let modules = ["community", "chapter", "subchapter", "cluster", "department", "subdepartment", "roles", "users", "settings", "documents", "conversations", "countries", "states", "cities", "userType", "roleType", "documentType", "documentFormat", "kycCategory", "Assets", "documentMapping", "template", "industry", "specification", "profession", "entity", "stageOfCompany", "processTypes", "businessType", "citizenship", "lookingFor","taxation","globalSettings","masterSettings","registration", "CommunityDefinition", "processMapping", "hierarchy", "identityTypes", "subProcess", "ideatorPortfolio", "Technologies", "SubDomain", "portfolioLibrary", "communityAccess", "templates", "services" , "templateTypes", "documentCategories", "filters", 'templateAssignment', 'transactionTypes', 'requestType', 'awards', 'fundingType','portfolio','transactionLog', "Regional", "dateAndTime", "dateFormat", "numerical", "socialLinks", "gender", "emailType"];
