                            ...
                            <div className="col-lg-9 col-md-9 col-sm-8">
                              <div className="form_bg col-md-6">
                                <form>
                                  ...
                                  <div className="form-group">
                                    <input type="text" placeholder="Name" className="form-control float-label" id="cluster_name"/>
                                  </div>

                                  <div className="form-group">
                                    <input type="text" placeholder="Company" className="form-control float-label" id="cluster_name" />
                                  </div>
                                  <div className="form-group">
                                    <input type="text" placeholder="Year of Experience" className="form-control float-label" id="cluster_name" />
                                  </div>
                              ...
                              <div className="form_bg col-md-6">
                                <form>
                                  ...
                                  <div className="form-group">
                                    <input type="text" placeholder="Designation" className="form-control float-label" id="cluster_name"/>
                                  </div>

                                  <div className="form-group">
                                    <input type="text" placeholder="Duration" className="form-control float-label" id="cluster_name" />
                                  </div>
                                  <div className="form-group">
                              ...
                              <div className="form_bg col-md-12">
                                <form>
                                  ...
                                  <div className="form-group">
                                    <input type="text" placeholder="About" className="form-control float-label" id="cluster_name"/>
                                  </div>
                            ...
                            <div className="col-lg-9 col-md-9 col-sm-8">
                              <div className="form_bg col-md-6">
                                <form>
                                  ...
                                  <div className="form-group">
                                    <input type="text" placeholder="Name" className="form-control float-label" id="cluster_name" disabled />
                                  </div>

                                  <div className="form-group">
                                    <input type="text" placeholder="Company" className="form-control float-label" id="cluster_name" disabled />
                                  </div>
                                  <div className="form-group">
                                    <input type="text" placeholder="Year of Experience" className="form-control float-label" id="cluster_name" disabled />
                                  </div>
                              ...
                              <div className="form_bg col-md-6">
                                <form>
                                  ...
                                  <div className="form-group">
                                    <input type="text" placeholder="Disignation" className="form-control float-label" id="cluster_name" disabled />
                                  </div>

                                  <div className="form-group">
                                    <input type="text" placeholder="Duration" className="form-control float-label" id="cluster_name" disabled />
                                  </div>
                                  <div className="form-group">
                                    <input type="text" placeholder="Qualification" className="form-control float-label" id="cluster_name" disabled />
                                  </div>
                              ...
                              <div className="form_bg col-md-12">
                                <form>
                                  ...
                                  <div className="form-group">
                                    <input type="text" placeholder="About" className="form-control float-label" id="cluster_name" disabled />
                                  </div>
