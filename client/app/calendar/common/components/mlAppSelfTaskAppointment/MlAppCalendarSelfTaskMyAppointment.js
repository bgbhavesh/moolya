...
import MlAppCalendarSelfTaskMyAppointmentInfo from './MlAppCalendarSelfTaskMyAppointmentInfo';
...
class MlAppCalendarSelfTaskMyAppointment extends Component {
      ...
      <div className="col-lg-12">
        <div className="app_padding_wrap">
          ...
          <div className="col-md-12">
            <MlAppCalendarSelfTaskMyAppointmentInfo selfTask={this.state.selfTask} />
          </div>
          {status !== 'Completed' &&
...
export default MlAppCalendarSelfTaskMyAppointment = formHandler()(MlAppCalendarSelfTaskMyAppointment);
