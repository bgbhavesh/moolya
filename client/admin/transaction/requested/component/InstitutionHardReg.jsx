...
export default class InstitutionHardReg extends React.Component{
  constructor(props){
    super(props);
  ...
  getRegistrationSteps(props){
    let hardRegSteps=[
      {name: 'Additional Info','icon':<span className="ml ml-additional-Information"></span>,  component: <Institution {...props} />},
