...
export default class MlAppSlotAppointmentDetails extends Component {
  ...
  async fetchAppointments() {
    const appointmetnIds = this.props.appointmentIds;
    const response = await fetchSlotAppointmentsDetailsActionHandler(appointmetnIds);
    if (response) {
      this.setState({
      ...
      <div className="app_main_wrap">
        <div className="app_padding_wrap">
          ...
          { that.state.appointmentsInfo.map((data, index) => {
            const appointmentType = data.appointmentType === 'SERVICE-TASK' ? 'External' : 'Internal';
                  ...
                  <div className="panel-body">
                    ...
                    <div className="col-md-12 naopadding att_members" >
                      <ul className="users_list">
                        {data.attendeeDetails ? data.attendeeDetails.map((info) => {
