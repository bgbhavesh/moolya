...
function getTopbar(OrgId) {
    ...
    //02 Create JScriptURL
    var JScriptURL = URLProtocol + '//' + RefDomain + '/t/LeadSquaredWidget.aspx?p1=' + OrgCode + '&p2=' + PageUrl + '&p3=' + Referrer + '&p4=' + PageTitle + '&p5=false' + '&p6=' + currentTimeStamp + '&p7=' + WidgetType;
...
function closeLSQTopbar(orgId) {
    ...
    var openTopbar = window.parent.document.getElementById('lsqtopbar-open');
