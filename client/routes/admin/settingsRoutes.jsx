...
adminSection.route('/settings/stepDetails/:subProcessId/:templateId/:stepCode', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminTemplatesHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'templates', subModule: 'stepCode'
        }} subProcessConfig={params.subProcessId} templateId={params.templateId} />,
      adminContent: <MlStepDetails templateId={params.templateId} subProcessConfig={params.subProcessId} stepCode={params.stepCode}/>
    })
  }
});
/*
...
adminSection.route('/settings/hierarchy/platformhierarchy', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHierarchyHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'hierarchy', subModule: 'platformHierarchy'
        }}/>,
      adminContent: < MlHierarchyList/>
    })
  }
});
adminSection.route('/settings/hierarchy/clusterhierarchy', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHierarchyHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'hierarchy', subModule: 'clusterHierarchy'
        }}/>,
      adminContent: <MlViews viewMode={false} showInfinity={false} mapConfig={mlClusterMapConfig} listConfig={mlClusterListConfig} />
    })
  }
});
adminSection.route('/settings/hierarchy/history', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHierarchyHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'hierarchy', subModule: 'history'
        }}/>,
      adminContent: <MlHierarchyTabHistoryList />
    })
  }
});
    ...
    mount(AdminLayout, {
      headerContent: <MlAdminHierarchyHeader
        breadcrum={{
          ...
          showBreadCrum: true,
          module: 'hierarchy',
          subModule: 'clusterHierarchy',
          dynamic: true
        }}/>,
      adminContent: < MlViews viewMode={false} showInfinity={false} params={params} listConfig={mlClusterSubChaptersListConfig}/>
    })
  }
});
adminSection.route('/settings/hierarchy/clusterhierarchy/:clusterId/:subChapterId/:defaultSubChapter/hierarchyDetails', {
  ...
  action(params) {
    ...
    mount(AdminLayout, {
      headerContent: <MlAdminHierarchyHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'hierarchy', subModule: 'clusterHierarchy', dynamic: true
        }} clusterId={params.clusterId}/>,
      adminContent: < MlHierarchyDepartmentsList clusterId={params.clusterId} subChapterId={params.subChapterId} defaultSubChapter={params.defaultSubChapter}/>
    })
  }
});
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'processMapping'
        }} />,
      adminContent: <MlProcessMappingList />
    })
  }
});
adminSection.route('/settings/documentProcess/addProcess', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: <MlAddProcessMapping />
    })
  }
});
...
adminSection.route('/settings/documentProcess/editProcess/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditProcessMapping config={params.id} />
    })
  }
});
...
adminSection.route('/settings/documentProcess/userTypeList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'userType', subModuleName: 'User Categories'
        }} />,
      adminContent: < MlUserTypeList/>
    })
  }
});
adminSection.route('/settings/documentProcess/editUserType/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: < MlEditUserType config={params.id}/>
    })
  }
});
...
adminSection.route('/settings/documentProcess/documentTypeList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'documentType', subModuleName: 'Document Types'
        }} />,
      adminContent: < MlDocumentTypesList/>
    })
  }
});
adminSection.route('/settings/documentProcess/addDocumentType', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddDocumentType/>
    })
  }
});
adminSection.route('/settings/documentProcess/editDocumentType/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditDocumentType config={params.id} />
    })
  }
});
adminSection.route('/settings/documentProcess/documentFormatList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'documentFormat', subModuleName: 'Document Formats'
        }} />,
      adminContent: < MlDocumentFormatsList/>
    })
  }
});
adminSection.route('/settings/documentProcess/addDocumentFormat', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddDocumentFormat/>
    })
  }
});
adminSection.route('/settings/documentProcess/editDocumentFormat/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditDocumentFormat config={params.id} />
    })
  }
});
adminSection.route('/settings/documentProcess/kycCategoryList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'kycCategory', subModuleName: 'KYC Category'
        }} />,
      adminContent: < MlKycCategoriesList/>
    })
  }
});
...
adminSection.route('/settings/documentProcess/editKycCategory/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditKycCategory config={params.id} />
    })
  }
});
adminSection.route('/settings/documentProcess/documentMappingList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'documentMapping'
        }} />,
      adminContent: < MlDocumentMappingList/>
    })
  }
});
adminSection.route('/settings/documentProcess/addDocumentMapping', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddDocumentMapping/>
    })
  }
});
adminSection.route('/settings/documentProcess/editDocumentMapping/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditDocumentMapping config={params.id} />
    })
  }
});
...
adminSection.route('/settings/documentProcess/industryList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'industry', subModuleName: 'Industries'
        }} />,
      adminContent: < MlIndustryTypeList/>
    })
  }
});
adminSection.route('/settings/documentProcess/addIndustry', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: <MlAddIndustryType />
    })
  }
});
adminSection.route('/settings/documentProcess/editIndustry/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditIndustryType config={params.id} />
    })
  }
});
adminSection.route('/settings/documentProcess/specificationList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'specification', subModuleName: 'Specifications'
        }} />,
      adminContent: < MlSpecificationTypeList/>
    })
  }
});
adminSection.route('/settings/documentProcess/addSpecification', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddSpecificationType />
    })
  }
});
adminSection.route('/settings/documentProcess/editSpecification/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditSpecificationType config={params.id} />
    })
  }
});
adminSection.route('/settings/documentProcess/professionList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'profession', subModuleName: 'Professions'
        }}/>,
      adminContent: < MlProfessionTypeList/>
    })
  }
});
adminSection.route('/settings/documentProcess/addProfession', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddProfessionType />
    })
  }
});
adminSection.route('/settings/documentProcess/editProfession/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditProfessionType config={params.id} />
    })
  }
});
...
adminSection.route('/settings/registration/entityList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'registration', subModule: 'entity'
        }} />,
      adminContent: < MlEntityTypeList/>
    })
  }
});
...
adminSection.route('/settings/registration/editEntity/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditEntityType config={params.id} />
    })
  }
});
adminSection.route('/settings/registration/stageOfCompanyList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'registration', subModule: 'stageOfCompany'
        }} />,
      adminContent: < MlStageOfCompanyTypeList/>
    })
  }
});
adminSection.route('/settings/registration/addStageOfCompany', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddStageOfCompanyType />
    })
  }
});
adminSection.route('/settings/registration/editStageOfCompany/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditStageOfCompanyType config={params.id} />
    })
  }
});
adminSection.route('/settings/registration/businessList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'registration', subModule: 'business'
        }} />,
      adminContent: < MlBusinessTypeList/>
    })
  }
});
adminSection.route('/settings/registration/addBusiness', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddBusinessType />
    })
  }
});
adminSection.route('/settings/registration/editBusiness/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditBusinessType config={params.id} />
    })
  }
});
adminSection.route('/settings/registration/citizenshipList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'registration', subModule: 'citizenship'
        }} />,
      adminContent: < MlCitizenshipTypeList/>
    })
  }
});
adminSection.route('/settings/registration/addCitizenship', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddCitizenshipType />
    })
  }
});
adminSection.route('/settings/registration/editCitizenship/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditCitizenshipType config={params.id} />
    })
  }
});
adminSection.route('/settings/registration/lookingForList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'registration', subModule: 'lookingFor'
        }} />,
      adminContent: < MlLookingForTypeList/>
    })
  }
});
adminSection.route('/settings/registration/addLookingFor', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: < MlAddLookingForType />
    })
  }
});
adminSection.route('/settings/registration/editLookingFor/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditLookingForType config={params.id} />
    })
  }
});
...
adminSection.route('/settings/documentProcess/subDomainList', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'setting', showBreadCrum: true, module: 'documentProcess', subModule: 'subDomain', subModuleName: 'Sub Domains'
        }} />,
      adminContent: <MlSubDomainList/>
    })
  }
});
...
adminSection.route('/settings/documentProcess/editSubDomain/:id', {
  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlEditSubDomain config={params.id} />
    })
  }
});
