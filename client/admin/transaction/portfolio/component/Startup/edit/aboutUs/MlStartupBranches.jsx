...
class MlStartupBranches extends Component {
  ...
  componentWillMount() {
    const empty = _.isEmpty(this.context.startupPortfolio && this.context.startupPortfolio.branches)
    if (!empty) {
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.startupBranches
  ...
  onTileClick(index, uiIndex, e) {
    const cloneArray = _.cloneDeep(this.state.startupBranches);
    // let details = cloneArray[index]
    let details = _.find(cloneArray, { index });
    details = _.omit(details, '__typename');
    this.curSelectLogo = details.logo
    this.setState({
      selectedIndex: index, data: details, selectedObject: uiIndex, popoverOpen: !(this.state.popoverOpen), selectedVal: details.addressTypeId, countryId: details.countryId, cityId: details.cityId, stateId: details.stateId
    });
    const privateFieldAry = _.filter(details.privateFields, { tabName: this.props.tabName });
    setTimeout(() => {
      _.each(privateFieldAry, (pf) => {
  ...
  onLockChange(fieldName, field, e) {
    ...
    if (fieldName === 'logo') { privateKey.objectName = 'logo'; }
  ...
  sendDataToParent(isSaveClicked) {
    ...
    const branches = this.state.startupBranches;
  ...
  onLogoFileUpload(e) {
    ...
    const data = {
      moduleName: 'PORTFOLIO', actionName: 'UPLOAD', portfolioDetailsId: this.props.portfolioDetailsId, portfolio: { branches: [{ logo: { fileUrl: '', fileName }, index: this.state.selectedIndex }] }
    };
  ...
  async fetchOnlyImages() {
    ...
    if (response) {
      ...
      const dataDetails = this.state.startupBranches
      const cloneBackUp = _.cloneDeep(dataDetails);
      const specificData = cloneBackUp[thisState];
      if (specificData) {
        const curUpload = response.branches[thisState]
...
`;
    ...
    const citiesQuery = gql`query ($stateId: String) {
    ...
    const citiesOption = { options: { variables: { stateId: this.state.stateId } } };
    const that = this;
    const showLoader = that.state.loading;
    const branchesArray = that.state.startupBranchesList || [];
    ...
    let branchNameActive = '',
      branchPhoneNumberActive = '',
      branchAddress1Active = '',
      branchAddress2Active = '',
      branchLandmarkActive = '',
      branchAreaAcitve = ''
            ...
            >
              <div className="col-lg-12">
                <div className="row">
                  ...
                  {branchesArray.map((details, idx) => (<div className="col-lg-2 col-md-3 col-sm-3" key={idx}>
                      ...
                      <div className="row">
                        <div className="col-md-12">
                          ...
                          <div className="form-group mandatory">
                            ...
                            <input
                              type="text" name="branchName" placeholder="Name" className="form-control float-label" ref={'branchName'}
                          ...
                          <div className="form-group mandatory">
                            ...
                            <input
                              type="text" name="branchAddress1" placeholder="Flat/House/Floor/Building"
                          ...
                          <div className="form-group mandatory">
                            ...
                            <input
                              type="text" name="branchAddress2" placeholder="Colony/Street/Locality"
                          ...
                          <div className="form-group">
                            <Moolyaselect
                              multiSelect={false} ref="country" className="form-control float-label"
                          ...
                          <div className="form-group">
                            <Moolyaselect
                              multiSelect={false} ref="state" className="form-control float-label"
                          ...
                          <div className="form-group">
                            <Moolyaselect
                              multiSelect={false} ref="town" className="form-control float-label"
