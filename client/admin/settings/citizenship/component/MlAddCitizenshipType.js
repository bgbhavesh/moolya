...
class MlAddCitizenship extends React.Component {
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/settings/registration/citizenshipList'); } else { toastr.error(response.result); }
    }
  }
            ...
            <div className="form_bg">
              <form>
                <div className="form-group mandatory">
                  <input
                    type="text" ref="citizenshipTypeName" placeholder="Citizenship Name"
          ...
          <div className="col-md-6 nopadding-right">
            <div className="form_bg">
              <form>
                <div className="form-group mandatory">
                  <input
                    type="text" ref="citizenshipTypeDisplayName" placeholder="Display Name"
