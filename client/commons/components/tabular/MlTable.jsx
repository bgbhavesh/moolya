...
export default class MlTable extends React.Component {
  ...
  render() {
    const selectRow = {
      ...
      clickToExpand: !!this.props.isExpandableRow,
    ...
    const columnItems = this.props.columns.map((cl) => {
      ...
      if (cl.customComponent) {
        const CustomComponent = cl.customComponent;
        let customColumnComponent = (cell, row) => <CustomComponent data={row} />;

        const useCustomComponent = cl.useCustomComponent;
