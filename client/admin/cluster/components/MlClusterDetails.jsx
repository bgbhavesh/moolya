...
class MlClusterDetails extends React.Component {
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/clusters'); } else { toastr.error(response.result); }
    }
  }
            ...
            <form >
              ...
              <div className="col-md-6 nopadding-left">
                <div className="form_bg">
                  <div className="form-group">
                    ...
                    <input
                      type="text" ref="countryName" placeholder="Cluster Name"
              ...
              <div className="col-md-6 nopadding-right">
                <div className="form_bg">
                  ...
                  <div className="form-group ">
                    <input
                      type="text" ref="email" placeholder="Email"
                  ...
                  <div className="form-group switch_wrap inline_switch">
                    ...
                    <label className="switch">
                      <input
                        type="checkbox" id="showOnMap" ref="showOnMap" checked={this.state.data && this.state.data.showOnMap}
