...
export default class MlCompanyAwards extends Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const empty = _.isEmpty(that.context.companyPortfolio && that.context.companyPortfolio.awardsRecognition)
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.awards
  ...
  onTileClick(index, uiIndex, e) {
    const cloneArray = _.cloneDeep(this.state.awards);
  ...
  lockPrivateKeys(selIndex) {
    const privateValues = this.CompanyAwardServer && this.CompanyAwardServer[selIndex] ? this.CompanyAwardServer[selIndex].privateFields : []
  ...
  sendDataToParent(isSaveClicked) {
    ...
    if (isSaveClicked) {
      let actualIndex = _.findIndex(awards, { index: this.state.selectedIndex });
  ...
  async fetchOnlyImages() {
    ...
    if (response && response.awardsRecognition) {
      ...
      const dataDetails = this.state.awards
  ...
  render() {
    ...
    const awardsList = that.state.awardsList || [];
              ...
              <ScrollArea
                ...
                <div className="col-lg-12">
                  <div className="row">
                    ...
                    {awardsList.map((details, idx) => (<div className="col-lg-2 col-md-3 col-sm-3" key={idx}>
