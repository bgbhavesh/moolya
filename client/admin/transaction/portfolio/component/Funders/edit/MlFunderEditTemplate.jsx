...
export default class MlFunderEditTemplate extends Component {
  constructor(props) {
    super(props)
    this.state = {
      tabs: [], aboutUs: {}, funderPortfolio: {}, portfolioKeys: { privateKeys: [], removePrivateKeys: [] }
    };
    ...
    const tabs = [
      {
        ...
        component: <MlFunderAbout
          client={client} tabName="funderAbout" isAdmin={true} key="1"
      ...
      },
      {
        ...
        component: <MlFunderPrincipalTeam
          client={client} tabName="Principals & Team" key="3"
      ...
      },
      {
        ...
        component: <MlFunderEngagementMethod
          key="4" tabName="Engagement Methods"
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
      ...
      },
      {
        ...
        component: <MlFunderSuccessStories
          key="7" tabName="successStories" client={client} isAdmin={true}
      ...
      },
      {
        ...
        component: <PortfolioLibrary
          key="8" client={client} tabName="Library" isAdmin={true}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        component: <MlFunderNews
          key="9" tabName="News" getFunderNewsDetails={this.getFunderNewsDetails.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
