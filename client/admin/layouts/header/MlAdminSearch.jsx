...
export default class MlAdminSearch extends Component {
  ...
  render() {
    ...
    const queryOptions = { options: { variables: { name: 'mlAdminRole', searchQuery: null } } };
    const query = gql`query RoleQuery($name: String!,$searchQuery:String) {data:FetchRoles(name: $name,searchQuery:$searchQuery){label:roleName,value:roleValue}}`;
    return (
