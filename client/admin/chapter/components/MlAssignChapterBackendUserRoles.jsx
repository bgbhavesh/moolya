...
export default class MlAssignChapterBackendUserRoles extends React.Component {
  ...
  optionsBySelectRole(index, did, selectedValue, callback, selObject) {
    ...
    if (selObject.label && selObject.label.indexOf('anchor') !== -1) {
      const anchorList = this.state.isAnchorTrue;
  ...
  async findUserDepartments() {
    ...
    const subChapterId = this.props.subChapterId;
    ...
    if ((userDefaultObj.hierarchyCode == 'PLATFORM' || userDefaultObj.hierarchyCode == 'CLUSTER') && this.props.isDefaultSubChapter) { this.setState({ showIsChapterAdmin: true }) } else { this.setState({ showIsChapterAdmin: false }); }
  ...
  render() {
    ...
    const chapterAdmin = that.state.chapterAdmin;
    const isChapterAdminCheck = that.state.isChapterAdminCheck;
                  ...
                  {department.isAvailiable ? (
                                ...
                                <div className="form-group">
                                  {(that.state.showIsChapterAdmin) ?
                                    <div className="input_types"><input
                                      id="chapter_admin_check" type="checkbox"
                                  ...
                                  <br className="brclear"/>
                                  {details.roleName ? <input
                                    type="text" defaultValue={details.roleName}
                    ...
                    <div>
                      <div className="panel-body">
                        ...
                        <div className="form-group">
                          <input
                            type="text" placeholder="Sub Department" className="form-control float-label"
                            id="sDept"
                        ...
                        {department.roles.map((details, idx) => (
                          <div className="form_inner_block" key={idx}>
                            <div className="form-group">
                              <input
                                type="text" defaultValue={details.roleName} placeholder="Role Name"
                                className="form-control float-label"
                                disabled="true"/>
                            </div>
                            <div className="form-group left_al">
