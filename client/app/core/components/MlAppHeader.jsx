        ...
        return(
            <div>
                ...
                <div className="ml_app_profile" role="navigation">
                    ...
                    <ol>
                      <li data-toggle="tooltip" title="My Profile" data-placement="right"><a href="/app/AppMyProfile"><img className="profile-img" src="/images/1.png" /></a></li>
                      <li data-toggle="tooltip" title="Log as" data-placement="right"><a href="#"><img className="profile-img" src="/images/2.png" /></a></li>
                      <li data-toggle="tooltip" title="Switch Profile" data-placement="right"><a href="/admin/switchProfile"><img className="profile-img" src="/images/3.png" /></a></li>
                      <li data-toggle="tooltip" title="Themes" data-placement="top"><a href="#"><img className="profile-img" src="/images/4.png" /></a></li>
                      <li data-toggle="tooltip" title="Logout" data-placement="top"><a href="#"><img className="profile-img" src="/images/5.png" /></a></li>
                    </ol>
                </div>
            </div>
        )
