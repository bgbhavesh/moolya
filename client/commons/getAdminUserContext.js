...
export function getAdminUserContext()
{
    ...
    let hierarchyLevel = null, hierarchyCode = null, defaultCluster = null, isMoolya = null, communityCode=null, roleName=null, roleId=null;
  ...
  return {hierarchyCode:hierarchyCode, hierarchyLevel:hierarchyLevel, clusterId:defaultCluster, isMoolya: isMoolya, communityCode:communityCode, roleName:roleName, roleId:roleId}
}
