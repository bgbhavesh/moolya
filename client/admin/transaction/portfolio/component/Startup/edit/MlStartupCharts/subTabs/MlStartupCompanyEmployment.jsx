...
export default class MlCompanyEmployment extends React.Component {
  ...
  fetchDetails() {
    const that = this;
    const empty = _.isEmpty(that.context.startupPortfolio && that.context.startupPortfolio.employmentOfCompanyChart)
    if (empty) {
      ...
      this.setState({ loading: false, startupCompanyEmployment: that.context.startupPortfolio.employmentOfCompanyChart, employmentList: that.context.startupPortfolio.employmentOfCompanyChart });
    }
  }
          ...
          <div className="panel panel-default">
            ...
            <div className="panel-body">
              <div className="office-members-detail">
                ...
                {that.state.employmentList.map((details, idx) => (<div className="form_inner_block" key={idx}>
