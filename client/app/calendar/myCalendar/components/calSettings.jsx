          ...
          <div className="col-md-12">
            <div className="col-md-6 nopadding-left">
              ...
              <div className="form-group">
                <select className="form-control"><option>Task type</option></select>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                <input className="form-control float-label" placeholder="Location"/>
              </div>
              <div className="form-group">
                <div className="input_types">
            ...
            <div className="col-md-6 nopadding-right">
              ...
              <div className="form-group">
                <select className="form-control"><option>Frequency</option></select>
              </div>
              <div className="form-group">
