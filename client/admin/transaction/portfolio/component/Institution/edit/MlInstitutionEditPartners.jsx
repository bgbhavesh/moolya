...
export default class MlInstitutionEditPartners extends React.Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const empty = _.isEmpty(that.context.institutionPortfolio && that.context.institutionPortfolio.partners)
  ...
  lockPrivateKeys(selIndex) {
    const privateValues = this.institutionPartnerServer && this.institutionPartnerServer[selIndex] ? this.institutionPartnerServer[selIndex].privateFields : []
              ...
              <ScrollArea speed={0.8} className="main_wrap_scroll" smoothScrolling={true} default={true}>
                <div className="col-lg-12">
                  <div className="row">
                    ...
                    {that.state.partnersList.map((principal, idx) => (
