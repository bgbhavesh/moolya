...
export default class ContactDetails extends React.Component {
  ...
  async onEditingContact(index, value) {
    ...
    const dbData = _.pluck(registrationDetails, 'numberType') || [];
          ...
          <div className="tab-content clearfix">
            <div className={`tab-pane${this.state.activeTab}`} id="contactA">
              <div className="form-group">
                <Moolyaselect
                  multiSelect={false} ref="numberType" placeholder="Select Number Type" query={numberTypeQuery}
            ...
            {that.state.contactNumberArray && (that.state.contactNumberArray.map((options, key) => {
              const test = that.state.contactNumberArray;
              return (<div className="tab-pane" id={`numberType${key}`} key={key} >
                ...
                <div className="form-group">
                  <input
                    type="text" placeholder="Enter Country Code" ref={`countryCode${key}`} defaultValue={options.countryCode} valueKey={options.countryCode}
                    className="form-control float-label" id=""/>
                </div>
                <div className="form-group">
                  <input
                    type="text" ref={`contactNumber${key}`} placeholder="Enter Number" valueKey={options.contactNumber} id="phoneNumber" defaultValue={options.contactNumber}
