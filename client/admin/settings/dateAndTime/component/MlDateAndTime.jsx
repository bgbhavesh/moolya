...
class MlAddDateAndTime extends React.Component {
  ...
  render() {
    ...
    const dateFormatquery = gql` query{  
      data:findDateFormat{
        value:_id
        label:dateFormatDisplayName
      }  
    }`;
    const timeFormatquery = gql` query{  
      data:findTimeFormat{
        value:_id
        label:timeFormatDisplayName
      }  
    }`;
    const weekDaysquery = gql` query{  
      data:findWeekDays{
        value:_id
        label:displayName
      }  
    }`;
    const timeZonequery = gql` query($clusterId:String){  
