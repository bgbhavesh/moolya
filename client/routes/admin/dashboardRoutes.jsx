...
adminSection.route('/dashboard', {
  triggersEnter: [function (context, redirect) {
    ...
    if (userDefaultObj.hierarchyCode == 'PLATFORM') { redirect('/admin/dashboard/clusters'); } else { redirect('/admin/dashboard/chapters'); }
  }]
...
adminSection.route('/dashboard/clusters', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader breadcrum={{ type: 'hierarchy', showBreadCrum: true, module: 'cluster' }} />,
      adminContent: <MlViews
        showInfinity={true} mapConfig={mlClusterDashboardMapConfig}
...
adminSection.route('/dashboard/chapters', {
  ...
  action() {
    mount(AdminLayout, {
      ...
      adminContent: <MlViews
        showInfinity={true} mapConfig={mlChapterDashboardMapConfig}
...
adminSection.route('/dashboard/communities', {
  ...
  action() {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader breadcrum={{ type: 'hierarchy', showBreadCrum: true, module: 'community' }} />,
      adminContent: <MlViews
        showInfinity={true} mapConfig={mlCommunityDashboardMapConfig}
...
adminSection.route('/dashboard/:clusterId/chapters', {
  ...
  action(params, queryParams) {
    ...
    mount(AdminLayout, {
      headerContent: <MlAdminHeader breadcrum={{ type: 'hierarchy', showBreadCrum: true, module: 'dashboard' }}/>,
      adminContent: <MlViews
        viewMode={viewMode} showInfinity={true} mapConfig={mlChapterDashboardMapConfig}
...
adminSection.route('/dashboard/:clusterId/:chapterId/subChapters', {
  ...
  action(params, queryParams) {
    ...
    mount(AdminLayout, {
      headerContent: <MlAdminHeader breadcrum={{ type: 'hierarchy', showBreadCrum: true, module: 'dashboard' }}/>,
      adminContent: <MlViews
        viewMode={viewMode} showInfinity={true} mapConfig={mlSubChapterDashboardMapConfig}
...
adminSection.route('/dashboard/:clusterId/:chapterId/:subChapterId/communities', {
  ...
  action(params, queryParams) {
    ...
    mount(AdminLayout, {
      headerContent: <MlAdminHeader breadcrum={{ type: 'hierarchy', showBreadCrum: true, module: 'dashboard' }}/>,
      adminContent: <MlViews
        viewMode={viewMode} showInfinity={true} mapConfig={mlCommunityDashboardMapConfig}
