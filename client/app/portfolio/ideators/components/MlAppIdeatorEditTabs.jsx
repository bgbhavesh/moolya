    ...
    const tabs = [
      {
        ...
        component: <MlIdeatorIdeas
          key="2" getIdeas={this.getIdeas.bind(this)} tabName="ideas" client={appClient}
      ...
      },
      {
        ...
        component: <MlIdeatorDetails
          key="1" isAdmin={false} client={appClient} tabName="portfolioIdeatorDetails"
      ...
      },
      {
        ...
        component: <MlIdeatorProblemsAndSolutions
          isAdmin={false} client={appClient} key="2" tabName="problemSolution"
          portfolioDetailsId={this.props.portfolioDetailsId}
      ...
      },
      {
        ...
        component: <MlIdeatorAudience
          key="3" isAdmin={false} client={appClient} tabName="audience"
          portfolioDetailsId={this.props.portfolioDetailsId}
      ...
      },
      {
        ...
        component: <PortfolioLibrary
          key="4" client={appClient} isAdmin={false}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        component: <MlIdeatorStrategyAndPlanning
          key="5" portfolioDetailsId={this.props.portfolioDetailsId}
      ...
      },
      {
        ...
        component: <MlIdeatorLookingFor
          key="7" portfolioDetailsId={this.props.portfolioDetailsId} tabName="lookingFor"
