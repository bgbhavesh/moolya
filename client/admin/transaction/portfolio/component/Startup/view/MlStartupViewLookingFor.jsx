...
export default class MlStartupViewLookingFor extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'startupLookingFor', quote: JSON.stringify(annotation) }
  ...
  render() {
    const that = this;
    const lookingforArray = that.state.startupLookingforList && that.state.startupLookingforList.lookingFor || [];
