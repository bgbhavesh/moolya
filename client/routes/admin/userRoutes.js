  ...
  action(params) {
    mount(AdminLayout, {
      ...
      adminContent: <MlViews
        viewMode={false} showInfinity={false}
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'users', showBreadCrum: true, module: 'clusters', subModule: 'aboutuser'
        }}/>,
...
adminSection.route('/users/:registrationId/:portfolioId/addressBook', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'users', showBreadCrum: true, module: 'clusters', subModule: 'addressBook'
        }}/>,
...
adminSection.route('/users/:registrationId/:portfolioId/portfolio', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'users', showBreadCrum: true, module: 'clusters', subModule: 'portfolio'
        }}/>,
...
adminSection.route('/users/:registrationId/:portfolioId/connections', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'users', showBreadCrum: true, module: 'clusters', subModule: 'connections'
        }}/>,
...
adminSection.route('/users/:registrationId/:portfolioId/favourites', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'users', showBreadCrum: true, module: 'clusters', subModule: 'favourites'
        }}/>,
...
adminSection.route('/users/:registrationId/:portfolioId/transactions', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'users', showBreadCrum: true, module: 'clusters', subModule: 'transactions'
        }}/>,
...
adminSection.route('/users/:registrationId/:portfolioId/view/library', {
  ...
  action(params) {
    mount(AdminLayout, {
      headerContent: <MlAdminHeader
        breadcrum={{
          type: 'users', showBreadCrum: true, module: 'clusters', subModule: 'library'
        }}/>,
