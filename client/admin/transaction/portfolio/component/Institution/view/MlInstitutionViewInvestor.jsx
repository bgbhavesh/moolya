...
export default class MlInstitutionViewInvestor extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'institutionInvestors', quote: JSON.stringify(annotation) }
  ...
  render() {
    const that = this;
    const investorArray = that.state.institutionInvestorList || [];
          ...
          <div>
            ...
            {!_.isEmpty(investorArray) && <div id="annotatorContent">
              ...
              <div className="col-lg-12">
                <div className="row">
                  {investorArray && investorArray.map((details, idx) => (<div className="col-lg-2 col-md-3 col-xs-12 col-sm-4" key={idx}>
