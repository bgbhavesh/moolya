...
Meteor.startup(() => {
  ...
  for (let i = 0; i < menus.length; i++) {
    ...
    if (!menu) {
      menu = {
        communityCode: menus[i].communityCode, communityName: menus[i].communityName, menuName: menus[i].menuName, isActive: menus[i].isActive, isProfileMenu: menus[i].isProfileMenu, isExploreMenu: menus[i].isExploreMenu
      };
