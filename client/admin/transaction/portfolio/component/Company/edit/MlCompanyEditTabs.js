...
export default class MlCompanyEditTabs extends Component {
  constructor(props) {
    super(props)
    this.state = {
      tabs: [], aboutUs: {}, companyPortfolio: {}, portfolioKeys: { privateKeys: [], removePrivateKeys: [] }
    };
    ...
    const tabs = [

      {
        ...
        component: <MlCompanyAboutUsLandingPage
          key="1" isAdmin={true} client={client} getAboutus={this.getAboutus.bind(this)}
      ...
      },
      {
        ...
        component: <MlCompanyData
          key="4" isApp={false} client={client} getDataDetails={this.getDataDetails.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        panelClassName: 'panel',
        title: 'Charts',
        component: <MlCompanyEditCharts
          key="5" getChartDetails={this.getChartDetails.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        component: <MlCompanyAwards
          key="6" client={client} getAwardsDetails={this.getAwardsDetails.bind(this)}
      ...
      }, //
      {
        ...
        component: <MlCompanyMCL
          key="8" client={client} getMCL={this.getMCL.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        component: <MlCompanyIncubatorsEditTabs
          key="9" client={client} getIncubators={this.getIncubators.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}
          backClickHandler={this.backClickHandler.bind(this)}/>
      },
      {
        ...
        component: <MlCompanyPartners
          key="10" client={client} getPartnersDetails={this.getPartnersDetails.bind(this)}
      ...
      },
      {
        ...
        component: <MlCompanyCSREditTabs
          key="11" client={client} getCSRDetails={this.getCSRDetails.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}
          backClickHandler={this.backClickHandler.bind(this)}/>
      },
      {
        ...
        component: <MlCompanyRAndD
          key="13" client={client} getRDDetails={this.getRDDetails.bind(this)}
