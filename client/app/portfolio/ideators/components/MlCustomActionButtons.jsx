      ...
      <div className="admin_padding_wrap">
        {showLoader === true ? (<MlLoader/>) : (
          <div>
            ...
            <Popover
              placement="top" className="footer_popover" isOpen={this.state.popoverOpen_pop_collaborate} target="pop_collaborate"
              toggle={this.toggle}>
            ...
            <Popover
              placement="top" className="footer_popover" isOpen={this.state.popoverOpen_pop_review} target="pop_review"
              toggle={this.toggle}>
            ...
            <Popover
              placement="top" className="footer_popover" isOpen={this.state.popoverOpen_pop_connect} target="pop_connect"
              toggle={this.toggle}>
            ...
            <Popover
              placement="top" className="footer_popover" isOpen={this.state.popoverOpen_pop_conersation} target="pop_conersation"
              toggle={this.toggle}>
              <PopoverTitle>Connect</PopoverTitle>
              <PopoverContent>
            ...
            <Popover
              placement="top" className="footer_popover" isOpen={this.state.popoverOpen_pop_inquiry} target="pop_inquiry"
              toggle={this.toggle}>
