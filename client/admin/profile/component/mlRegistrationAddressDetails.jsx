...
export default class AddressDetails extends React.Component {
  ...
  async onEditAddress(index, value) {
    ...
    if (index !== -1) {
      ...
      const dbData = _.pluck(registrationDetails, 'addressType') || [];
        ...
        <div className="ml_tabs">
          ...
          <div className="tab-content clearfix">
            ...
            <div className={`tab-pane${this.state.activeTab}`} id="1a">
              ...
              <div className="form-group">
                <input
                  type="text" ref={'addressCountry'} placeholder="Country" name ={'addressCountry'}
            ...
            {that.state.addressDetails && (that.state.addressDetails.map((options, key) => (
              <div className="tab-pane" id={`adressType${key}`} key={key}>
                ...
                <div className="form-group">
                  <input
                    type="text" ref={`addressState${key}`} placeholder="State" name ={'addressState'}
                    className="form-control float-label" id="" defaultValue={options.addressState} />
                </div>
                <div className="form-group">
                  <input
                    type="text" ref={`addressCountry${key}`} placeholder="Country" name ={'addressCountry'}
                ...
                <div className="form-group">
                  <input
                    type="text" ref={`latitude${key}`} placeholder="Latitude" name ={'latitude'}
                    className="form-control float-label" id="" defaultValue={options.latitude}/>
                </div>
                <div className="form-group">
                  <input
                    type="text" ref={`longitude${key}`} placeholder="Longitude" name ={'longitude'}
