...
export default class MlServiceProviderClients extends Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const empty = _.isEmpty(that.context.serviceProviderPortfolio && that.context.serviceProviderPortfolio.clients)
    ...
    this.serviceProviderClientsServer = response || []
  }
  ...
  onTileSelect(index, uiIndex, e) {
    const cloneArray = _.cloneDeep(this.state.serviceProviderClients);
  ...
  lockPrivateKeys(selIndex) {
    const privateValues = this.serviceProviderClientsServer && this.serviceProviderClientsServer[selIndex] ? this.serviceProviderClientsServer[selIndex].privateFields : []
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.serviceProviderClients
    if (this.context && this.context.serviceProviderPortfolio && this.context.serviceProviderPortfolio.clients) { setObject = this.context.serviceProviderPortfolio.clients }
  ...
  sendDataToParent(isSaveClicked) {
    ...
    const clients = this.state.serviceProviderClients;
    ...
    const arr = [];
    _.each(serviceProviderClients, (item) => {
    ...
    this.setState({ serviceProviderClients })
  ...
  onLogoFileUpload(image, fileInfo) {
    ...
    if (file) {
      const data = {
        ...
        portfolio: { clients: [{ logo: { fileUrl: '', fileName }, index: this.state.selectedIndex }] }
      };
  ...
  async fetchOnlyImages() {
    ...
    if (response) {
      ...
      const dataDetails = this.state.serviceProviderClients
              ...
              <div className="col-lg-12">
                <div className="row">
                  ...
                  /*  if(details.makePrivate){
                    ...
                    (<div className="col-lg-2 col-md-3 col-sm-3" key={idx}>
                      <a id={`create_client${idx}`}>
                        <div className="list_block">
                          ...
                          <div
                            className="hex_outer portfolio-font-icons"
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <div className="form-group mandatory">
                          <input
                            type="text" name="companyName" placeholder="Company Name" ref={'companyName'}
                        ...
                        <div className="form-group">
                          <input
                            type="text" name="clientDescription" placeholder="About" className="form-control float-label"
                            id="" defaultValue={this.state.data.clientDescription} onBlur={this.handleBlur}/>
                          <FontAwesome
                            name='unlock' className="input_icon un_lock" id="isClientDescriptionPrivate"
