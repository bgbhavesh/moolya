...
export default class MlInstitutionEditIntrapreneur extends React.Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const empty = _.isEmpty(that.context.institutionPortfolio && that.context.institutionPortfolio.intrapreneurRecognition)
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.institutionIntrapreneur
  ...
  lockPrivateKeys(selIndex) {
    const privateValues = this.institutionIntrapreneurServer && this.institutionIntrapreneurServer[selIndex] ? this.institutionIntrapreneurServer[selIndex].privateFields : []
