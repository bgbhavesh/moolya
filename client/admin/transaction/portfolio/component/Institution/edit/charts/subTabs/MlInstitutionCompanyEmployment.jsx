...
export default class MlInstitutionCompanyEmployment extends React.Component{
  ...
  fetchDetails(){
    ...
    let empty = _.isEmpty(that.context.institutionPortfolio && that.context.institutionPortfolio.employmentOfCompanyChart)
    if(empty){
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-10">
                    <div className="row">
                      <div className="form-group col-lg-6">
                        <div className="form-group col-md-6 col-sm-6 padl0">
                        ...
                        <div className="form-group col-md-6 col-sm-6 padr0">
