  ...
  getTabComponents() {
    const tabs = [
      ...
      },
      {
        ...
        title: 'Rating',
        name: 'Rating',
        component: <MlStartupViewRating
          key="2" portfolioDetailsId={this.props.portfolioDetailsId}
          getSelectedAnnotations={this.props.getSelectedAnnotations}
      ...
      },
      {
        ...
        title: 'Clients',
        name: 'Clients',
        component: <MlStartupViewClients
          key="3" portfolioDetailsId={this.props.portfolioDetailsId} tabName="clients"
          getSelectedAnnotations={this.props.getSelectedAnnotations}
      ...
      },
      {
        ...
        component: <MlStartupViewServicesAndProducts
          key="4" portfolioDetailsId={this.props.portfolioDetailsId} tabName="serviceProducts"
          getSelectedAnnotations={this.props.getSelectedAnnotations}
      ...
      },
      {
        ...
        title: 'Information',
        name: 'Information',
        component: <MlStartupViewInformation
          key="5" portfolioDetailsId={this.props.portfolioDetailsId} tabName="information"
          getSelectedAnnotations={this.props.getSelectedAnnotations}
      ...
      },
      {
        ...
        title: 'Assets',
        name: 'Assets',
        component: <MlStartupViewAssets
          key="2" portfolioDetailsId={this.props.portfolioDetailsId} tabName="assets"
          getSelectedAnnotations={this.props.getSelectedAnnotations}
      ...
      },
      {
        ...
        title: 'Branches',
        name: 'Branches',
        component: <MlStartupViewBranches
          key="8" portfolioDetailsId={this.props.portfolioDetailsId} tabName="branches"
          getSelectedAnnotations={this.props.getSelectedAnnotations}
      ...
      },
      {
        ...
        title: 'Technologies',
        name: 'Technologies',
        component: <MlStartupViewTechnologies
          key="2" portfolioDetailsId={this.props.portfolioDetailsId} tabName="technologies"
          getSelectedAnnotations={this.props.getSelectedAnnotations}
      ...
      },
      {
        ...
        title: 'Legal Issue',
        name: 'Legal Issue',
        component: <MlStartupViewLegalIssues
          key="9" portfolioDetailsId={this.props.portfolioDetailsId} tabName="legalIssue"
          getSelectedAnnotations={this.props.getSelectedAnnotations}
