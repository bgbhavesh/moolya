...
export default class MlAppCompaniesEditTabs extends Component {
  constructor(props) {
    ...
    this.state = {
      tabs: [],
      companyPortfolio: {},
      portfolioKeys: { privateKeys: [], removePrivateKeys: [] },
      activeTab: 'About'
    };
    ...
    const tabs = [
      {
        ...
        title: 'About',
        name: 'About',
        component: <MlCompanyAboutUsLandingPage
          key="1" client={appClient} getAboutus={this.getAboutus.bind(this)}
      ...
      },
      {
        ...
        title: 'Management',
        name: 'Management',
        component: <MlCompanyManagement
          client={appClient} isAdmin={false} key="2" tabName={'management'}
      ...
      },
      {
        ...
        title: 'Data',
        name: 'Data',
        component: <MlCompanyData
          key="4" isApp={false} client={appClient}
      ...
      },
      {
        ...
        title: 'Charts',
        name: 'Charts',
        component: <MlCompanyCharts
          key="5" client={appClient} isAdmin={false}
      ...
      },
      {
        ...
        title: 'Awards',
        name: 'Awards',
        component: <MlCompanyAwards
          key="6" getAwardsDetails={this.getAwardsDetails.bind(this)} client={appClient}
      ...
      },
      {
        ...
        component: <PortfolioLibrary
          key="7" client={appClient} isAdmin={false}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      }, //
      {
        tabClassName: 'tab',
        ...
        title: 'M C & L',
        name: 'M C And L',
        component: <MlCompanyMCL
          key="8" client={appClient} getMCL={this.getMCL.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}/>
      },
      {
        tabClassName: 'tab',
        ...
        title: 'Incubators',
        name: 'Incubators',
        component: <MlCompanyIncubatorsEditTabs
          key="9" client={appClient} getIncubators={this.getIncubators.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}
          backClickHandler={this.setBackHandler.bind(this)} isApp={true}/>
      },
      {
        ...
        title: 'Partners',
        name: 'Partners',
        component: <MlCompanyPartners
          key="10" client={appClient}
      ...
      },
      {
        ...
        title: 'CSR',
        name: 'CSR',
        component: <MlCompanyCSREditTabs
          key="11" client={appClient} getCSRDetails={this.getCSRDetails.bind(this)}
          portfolioDetailsId={this.props.portfolioDetailsId}
          backClickHandler={this.setBackHandler.bind(this)} isApp={true}/>
      },
      {
        ...
        title: 'R&D',
        name: 'R And D',
        component: <MlCompanyRAndD
          key="13" client={appClient} getRDDetails={this.getRDDetails.bind(this)}
      ...
      },
      {
        ...
        title: 'Intrapreneur',
        name: 'Intrapreneur',
        component: <MlCompanyIntrapreneur
          key="12" client={appClient}
      ...
      },
      {
        ...
        title: 'Looking For',
        name: 'Looking For',
        component: <MlCompanyLookingFor
          key="14" client={appClient}
  ...
  getAboutus(details, tabName, privateKey, requiredFields) {
    const data = this.state.companyPortfolio;
  ...
  render() {
    ...
    return <MlTabComponent
      tabs={tabs} selectedTabKey={this.state.activeTab} onChange={this.updateTab} type="tab"
      mkey="title"/>
  }
}
