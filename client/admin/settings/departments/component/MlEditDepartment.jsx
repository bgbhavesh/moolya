...
class MlEditDepartment extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true, data: {}, departmentAvailability: [], isMoolya: ''
    };
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/settings/departmentsList'); } else { toastr.error(response.result); }
      FlowRouter.go('/admin/settings/departmentsList');
    }
  }

  async findDepartment() {
    const departmentId = this.props.config
                ...
                <div className="col-md-6 nopadding-left">
                  <div className="form_bg">
                    <form>
                      ...
                      <div className="form-group mandatory">
                        <input
                          ref="displayName" defaultValue={this.state.data && this.state.data.displayName}
                      ...
                      <div className="form-group">
                        <textarea
                          ref="aboutDepartment" defaultValue={this.state.data && this.state.data.departmentDesc}
                      ...
                      <div className="form-group switch_wrap inline_switch">
                        ...
                        <label className="switch">
                          <input
                            type="checkbox" ref="departmentStatus"
                    ...
                    <form>
                      ...
                      <div className="form-group switch_wrap switch_names">
                        ...
                        <span className="state_label acLabel">EcoSystem</span><label className="switch nocolor-switch">
                          <input
                            type="checkbox" ref="appType" disabled="true" checked={!this.state.isMoolya}
                      ...
                      {this.state.isMoolya ?
                        ...
                        <MlAssignDepartments
                          getDepartmentAvailability={this.getDepartmentAvailability.bind(this)}
