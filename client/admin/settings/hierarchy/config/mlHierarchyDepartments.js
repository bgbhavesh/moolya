...
const mlHierarchyDepartmentsTableConfig = new MlViewer.View({
  ...
  actionConfiguration: [],
  queryOptions: true,
  buildQueryOptions: config => ({ context: { clusterId: config.params.clusterId, subChapterId: config.params.subChapterId, defaultSubChapter: config.params.defaultSubChapter } }),
  graphQlQuery:
