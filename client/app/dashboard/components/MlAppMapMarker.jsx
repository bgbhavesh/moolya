...
export default class MlAppMapMarker extends Component {
  ...
  render() {
    ...
    const name = this.props.status && this.props.status.firstName ? this.props.status.firstName : `${'' + ' '}${this.props.status}` && this.props.status.lastName ? this.props.status.lastName : ''
    return (
      <div>
