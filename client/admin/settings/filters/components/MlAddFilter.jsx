...
export default class MlEditFilter extends Component {
  ...
  async fetchSelectedFilterData() {
    ...
    this.setState({
      loading: false, data: response, transactionId: response.moduleName, filterData: response.filterFields
    });
  }
  ...
  render() {
    ...
    /*   let transactionType=gql`query  {
     ...
     `; */
    const transactionType = gql` query{data:fetchModules{label:name,value:name}}`;
