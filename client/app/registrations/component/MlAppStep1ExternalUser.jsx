...
export default class MlAppStep1ExternalUser extends Component {
  ...
  componentWillMount() {
    ...
    const details = this.props.registrationInfo || {}
    this.setState({
      loading: false,
  ...
  async fetchSubChapterDetails() {
    const result = await fetchSubChapterDetails(this.state.subChapter)
 ...
 data:fetchCountries {
  ...
  data:fetchChaptersWithoutAll(id:$id) {
    ...
    /*    let citiesquery = gql`query{
     ...
     `; */
    const citiesquery = gql`query($countryId:String){
...
`;
    ...
    const userTypeOption = { options: { variables: { communityCode: this.state.registrationType } } };
    const chapterOption = { options: { variables: { id: this.state.cluster } } };
    const subChapterOption = { options: { variables: { id: this.state.chapter, displayAllOption: false } } }
    ...
    const identityTypez = _.filter(that.state.identityTypesData, i => _.indexOf(i.communities, that.state.registrationType) >= 0) || [];
    const canSelectIdentity = !!(identityTypez && identityTypez.length > 0);
    const countryOption = { options: { variables: { countryId: this.state.country } } };
    let referedActive = '',
      institutionAssociationActive = ''
                ...
                <div className="form_bg">
                  <form>
                    <div className="form-group">
                      <input
                        type="text" ref="datetime" placeholder="Date & Time"
                    ...
                    <div className="form-group">
                      <input
                        type="text" placeholder="Request ID" defaultValue={that.state.registrationId}
                        className="form-control float-label" disabled="true"/>
                    </div>
                    <div className="form-group mandatory">
                      <input
                        type="text" ref="firstName" placeholder="First Name"
                    ...
                    <div className="form-group mandatory">
                      <input
                        type="text" ref="lastName" placeholder="Last Name"
                    ...
                    <div className="form-group">
                      <Moolyaselect
                        multiSelect={false} placeholder="Registration Type"
                    ...
                    <div className="panel panel-default">
                      ...
                      <div className="panel-body">
                        ...
                        <Moolyaselect
                          multiSelect={false} placeholder="Select Sub Chapter"
                          className="form-control float-label" valueKey={'value'} labelKey={'label'}
                        ...
                        <div className="form-group nomarginbot">
                          {identityTypez.map((i, idx) => {
                            let checked = null,
                              showRadioChecked = false
                            const identity = this.state.identityType
                            ...
                            return (
                              <div key={idx}>{showRadioChecked && <div>
                                <div id={`${i._id}Id`} className="input_types">
                                  ...
                                  <input
                                    type="checkbox" name={i.identityTypeName} value={i._id}
                        ...
                        <div className="form-group">
                          <Moolyaselect
                            multiSelect={false} placeholder="Select Type Of Industry"
                            className="form-control float-label" valueKey={'value'} labelKey={'label'}
                        ...
                        <div className="form-group">
                          <input
                            type="text" placeholder="Device Number"
                        ...
                        <div className="form-group">
                          <input
                            type="text" placeholder="IP Location"
              ...
              <div className="col-md-6">
                ...
                <div className="form_bg">
                  <form>
                    ...
                    <div className="form-group">
                      <input
                        type="text" placeholder="User Name" ref="userName"
                    ...
                    <div className="form-group">
                      ...
                      <Select
                        name="form-field-name" ref="refered" placeholder="How Did You Know About Us"
