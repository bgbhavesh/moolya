...
export default class MlStartupViewInvestor extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'startupInvestors', quote: JSON.stringify(annotation) }
  ...
  render() {
    const that = this;
    const investorArray = that.state.startupInvestorList || [];
