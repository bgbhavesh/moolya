...
class MlAddFundingType extends React.Component {
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/settings/fundingTypeList'); } else { toastr.error(response.result); }
    }
  }
...
export default MlAddFundingType = formHandler()(MlAddFundingType);
