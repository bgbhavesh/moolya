...
export default class MlCompanyViewLookingFor extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'companyLookingFor', quote: JSON.stringify(annotation) }
  ...
  render() {
    const that = this;
    const lookingforArray = (that.state.companyLookingforList && that.state.companyLookingforList.lookingFor) || [];
