...
export default class MlServiceProviderLookingFor extends Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const empty = _.isEmpty(that.context.serviceProviderPortfolio && that.context.serviceProviderPortfolio.lookingFor)
    ...
    this.serviceProviderLookingForServer = response || []
  }
  ...
  onTileClick(index, e) {
    const cloneArray = _.cloneDeep(this.state.serviceProviderLookingFor);
  ...
  lockPrivateKeys(selIndex) {
    const privateValues = this.serviceProviderLookingForServer && this.serviceProviderLookingForServer[selIndex] ? this.serviceProviderLookingForServer[selIndex].privateFields : []
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.serviceProviderLookingFor
    if (this.context && this.context.serviceProviderPortfolio && this.context.serviceProviderPortfolio.lookingFor) { setObject = this.context.serviceProviderPortfolio.lookingFor }
  ...
  sendDataToParent(isSaveClicked) {
    ...
    const serviceProviderLookingFor1 = this.state.serviceProviderLookingFor;
    ...
    const arr = [];
    _.each(serviceProviderLookingFor, (item) => {
    ...
    this.setState({ serviceProviderLookingFor })
  ...
  render() {
    ...
    const lookingOption = { options: { variables: { communityCode: 'SPS' } } };
    const that = this;
    const serviceProviderLookingForList = that.state.serviceProviderLookingForList || [];
    return (
      <div>
              ...
              >
                <div className="col-lg-12">
                  <div className="row">
                    ...
                    {serviceProviderLookingForList.map((details, idx) => (<div className="col-lg-2 col-md-3 col-sm-3" key={idx}>
