...
function dateFormatter(data) {
  const createdDateTime = data && data.data && data.data.createdAt;
...
const mlUserTransactions = new MlViewer.View({
  ...
  queryOptions: true,
  buildQueryOptions: config => ({ context: { registrationId: config && config.registrationId ? config.registrationId : null } }),
  actionConfiguration: [],
