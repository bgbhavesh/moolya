...
const mlHistoryTableConfig = new MlViewer.View({
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'CLUSTER,CHAPTER,SUBCHAPTER,COMMUNITY,USERS' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
