...
var everyDayJob = cron.schedule('*/2 * * * *', Meteor.bindEnvironment(() => {    
...
var alternateDayJob = cron.schedule('*/3 * * * *', Meteor.bindEnvironment(() => {    
...
// at every week "0 0 * * 0"
var everyWeekJob = cron.schedule('*/5 * * * *', Meteor.bindEnvironment(() => {    
