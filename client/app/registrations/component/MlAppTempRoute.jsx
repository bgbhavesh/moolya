      ...
      <div className="app_main_wrap">
        <div className="app_padding_wrap">
          <div className="col-md-12 ideators_list">
            <div className="row">
              {this.state.register.map((reg, idx) => {
                if (reg && reg.registrationInfo && reg.registrationInfo.communityName == 'Ideators') { icon = 'ml my-ml-Ideator' } else if (reg && reg.registrationInfo && reg.registrationInfo.communityName == 'Investors') { icon = 'ml my-ml-Investors' } else if (reg && reg.registrationInfo && reg.registrationInfo.communityName == 'Startups') { icon = 'ml my-ml-Startups' } else if (reg && reg.registrationInfo && reg.registrationInfo.communityName == 'Companies') { icon = 'ml my-ml-Company' } else if (reg && reg.registrationInfo && reg.registrationInfo.communityName == 'Service Providers') { icon = 'Service-Providers' } else if (reg && reg.registrationInfo && reg.registrationInfo.communityName == 'Institutions') { icon = 'ml my-ml-Institutions' }
                console.log(icon)
                return (
