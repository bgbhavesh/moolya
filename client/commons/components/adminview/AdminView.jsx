...
export default class MoolyaAdminView extends Component {
  ...
  render() {
    ...
    const infinityViewProps = { viewMode: this.props.viewMode, onViewModeChange: this.props.onViewModeChange };
    const listViewProps = {
      clusterListOptions: this.props.clusterListOptions, listRouterPath: this.props.listRouterPath, imageLink: this.props.imageLink, nameField: this.props.nameField, statusField: this.props.statusField
    }
    const footerProps = { footerOptions: this.props.footerOptions, routerPath: this.props.routerPath, imagePath: this.props.imagePath }
    return (
      <div>
