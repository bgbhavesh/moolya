...
export default class MlCompanyRAndD extends Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const empty = _.isEmpty(that.context.companyPortfolio && that.context.companyPortfolio.researchAndDevelopment)
    ...
    this.CompanyresearchServer = response && response.researchAndDevelopment ? response.researchAndDevelopment : []
  }
  addRD() {
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.companyRD
  ...
  onTileClick(index, uiIndex, e) {
    const cloneArray = _.cloneDeep(this.state.companyRD);
  ...
  lockPrivateKeys(selIndex) {
    const privateValues = this.CompanyresearchServer && this.CompanyresearchServer[selIndex] ? this.CompanyresearchServer[selIndex].privateFields : []
  ...
  async fetchOnlyImages() {
    ...
    if (response && response.researchAndDevelopment) {
      const dataDetails = this.state.companyRD
  ...
  render() {
    ...
    const companyRDList = that.state.companyRDList || [];
              ...
              <ScrollArea
                ...
                <div className="col-lg-12">
                  <div className="row">
                    ...
                    {companyRDList && companyRDList.map((details, idx) => (<div className="col-lg-2 col-md-3 col-sm-3" key={idx}>
