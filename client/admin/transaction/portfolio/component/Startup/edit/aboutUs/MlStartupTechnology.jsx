...
export default class MlStartupTechnology extends React.Component{
  ...
  sendDataToParent(){
    ...
    let startupTechnologies = this.state.startupTechnologies;
    startupTechnologies[this.state.index] = data;
    this.setState({startupTechnologies:startupTechnologies}, function () {
                ...
                <div className="col-lg-2 col-md-3 col-sm-3">
                  <a href="#" >
                    <div className="list_block">
                      ...
                      <div className="hex_outer"><img src="/images/meteor-logo.png"/></div>
              ...
              <div className="ml_create_client">
                <div className="medium-popover"><div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="form-group">
                      <input type="text" name="description" placeholder="Description" className="form-control float-label" id=""  onBlur={this.handleBlur.bind(this)}/>
