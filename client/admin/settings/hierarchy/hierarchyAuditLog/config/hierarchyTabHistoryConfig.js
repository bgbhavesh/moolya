...
const mlHierarchyTabHistoryTableConfig = new MlViewer.View({
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'HIERARCHY' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
