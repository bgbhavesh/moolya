...
export default class MlInstitutionEmployeeBreakup extends React.Component {
  ...
  fetchDetails() {
    ...
    const empty = _.isEmpty(that.context.institutionPortfolio && that.context.institutionPortfolio.employeeBreakupDepartmentChart)
    if (empty) {
      this.setState({ loading: false, startupCompanyData: that.props.dataDetails, dataList: that.props.dataDetails });
    } else {
      this.setState({ loading: false, startupCompanyData: that.context.institutionPortfolio.employeeBreakupDepartmentChart, dataList: that.context.institutionPortfolio.employeeBreakupDepartmentChart });
    }
  }
  ...
  onSaveAction(index, e) {
    ...
    const clients = this.state.startupCompanyData;
    clients[index] = data
    this.setState({ startupCompanyData: clients })
    this.props.getStartupEmployeeBreakup(clients);
  ...
  render() {
    const that = this;
    const revenueArray = this.state.dataList && this.state.dataList.length > 0 ? this.state.dataList : []
    const defaultIndex = revenueArray && revenueArray.length > 0 ? revenueArray.length : 0
    const departmentQuery = gql`query{ data:fetchDepartments{value:_id,label:departmentName}}`;
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-10">
                    <div className="row">
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <Moolyaselect
                          multiSelect={false} placeholder="Select Department"
                      ...
                      <div className="form-group col-lg-6">
                        ...
                        <div className="form-group col-md-6 col-sm-6">
                          <Datetime
                            dateFormat="MMMM" timeFormat={false} viewMode="months"
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <input
                          type="text" placeholder="Number of Employment" ref={`ebdNumberOfEmployment${defaultIndex}`} className="form-control float-label"
                          id="" name="ebdNumberOfEmployment" onBlur={this.employeementHandleBlur.bind(this, defaultIndex)}/>
                      </div>

                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <textarea
                          rows="1" placeholder="About" ref={`ebdAbout${defaultIndex}`} className="form-control float-label"
                          id="" name="ebdAbout" onBlur={this.aboutHandleBlur.bind(this, defaultIndex)}></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                {that.state.dataList.map((details, idx) => (<div className="form_inner_block">
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-10">
                    <div className="row">
                      ...
                      <div className="form-group col-lg-6">
                        <div className="form-group col-md-6 col-sm-6">
                          <Datetime
                            dateFormat="YYYY" timeFormat={false} viewMode="years" defaultValue={details.ebdFromYear}
                        ...
                        <div className="form-group col-md-6 col-sm-6">
                          <Datetime
                            dateFormat="MMMM" timeFormat={false} viewMode="months" defaultValue={details.ebdFromMonth}
                            inputProps={{ placeholder: 'Select Year', className: 'float-label form-control', readOnly: true }}
                      ...
                      <div className="form-group col-lg-6">
                        <div className="form-group col-md-6 col-sm-6">
                          <Datetime
                            dateFormat="YYYY" timeFormat={false} viewMode="years" defaultValue={details.ebdToYear}
                            inputProps={{ placeholder: 'Select Year', className: 'float-label form-control', readOnly: true }}
                        ...
                        <div className="form-group col-md-6 col-sm-6">
                          <Datetime
                            dateFormat="MMMM" timeFormat={false} viewMode="months" defaultValue={details.ebdToMonth}
                            inputProps={{ placeholder: 'Select Year', className: 'float-label form-control', readOnly: true }}
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <input
                          type="text" placeholder="Number of Employment" ref={`ebdNumberOfEmployment${idx}`}
                      ...
                      <div className="form-group col-lg-6 col-md-6 col-sm-6">
                        <textarea
                          rows="1" placeholder="About" ref={`ebdAbout${idx}`} className="form-control float-label"
...
MlInstitutionEmployeeBreakup.contextTypes = {
