...
export default class RegisterForm extends React.Component{
  ...
  render(){
    ...
    [
      ...
      {name: 'Additional info','icon':<span className="ml ml-additional-Information"></span>,  component: <Step2 registrationId={registrationId} registrationDetails={this.state.registrationDetails&&this.state.registrationDetails.registrationDetails} community={this.state.registrationDetails&&this.state.registrationDetails.registrationInfo.communityName}/>},
