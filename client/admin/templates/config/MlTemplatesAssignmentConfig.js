...
function creatorDateFormatter(data) {
  if (data && data.data && data.data.createdDate) {
    const createdDateTime = data && data.data && data.data.createdDate ? data.data.createdDate : '';
...
function modifiedDateFormatter(data) {
  if (data && data.data && data.data.modifiedDate) {
    const modifiedDateTime = data && data.data && data.data.modifiedDate ? data.data.modifiedDate : '';
