...
function createdateFormatter(data) {
  console.log(data)
  const createdAt = data && data.data && data.data.updatedAt;
  if (createdAt) {
...
const mlProcessSetupRequestsTableConfig = new MlViewer.View({
  ...
  columns: [
    ...
    {
      dataField: 'userDetails.clusterName', title: 'Cluster', dataSort: true, selectRow: true, customComponent(data) { return <div>{data.data.userDetails.clusterName}</div> }
    },
    {
      dataField: 'userDetails.chapterName', title: 'Scope', dataSort: true, selectRow: true, customComponent(data) { return <div>{data.data.userDetails.chapterName}</div> }
    },
    {
      dataField: 'userDetails.subChapterName', title: 'SubChapter', dataSort: true, selectRow: true, customComponent(data) { return <div>{data.data.userDetails.subChapterName}</div> }
    },
    {
      dataField: 'userDetails.communityName', title: 'Community', dataSort: true, selectRow: true, customComponent(data) { return <div>{data.data.userDetails.communityName}</div> }
    },
    {
