...
MlProviderPromocodesJournal = new Mongo.Collection('MlProviderPromocodesJournal');

var MlProviderPromocodeJournalSchema=new SimpleSchema({
	...
	providerType:{
		type:String,
		optional:true,
		allowedValues: providerTypeForPromoCode,
		label: "Provider Type"
	},
	locationName:{
		type:String,
...
//MlCollections.MlProviderPromocodesJournal = MlProviderPromocodesJournal;
//MlSchemas.MlProviderPromocodeJournalSchema = MlProviderPromocodeJournalSchema;
MlProviderPromocodesJournal.attachSchema(MlProviderPromocodeJournalSchema);