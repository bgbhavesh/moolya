...
export default class MlInstitutionViewLookingFor extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'institutionLookingFor', quote: JSON.stringify(annotation) }
  ...
  render() {
    const that = this;
    const lookingforArray = (that.state.institutionLookingforList && that.state.institutionLookingforList.lookingFor) || [];
