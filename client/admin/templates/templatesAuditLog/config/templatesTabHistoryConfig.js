...
const mlTemplatesTabHistoryTableConfig = new MlViewer.View({
  name: 'auditLogTable',
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'TEMPLATE,TEMPLATEASSIGMENT' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
...
export { mlTemplatesTabHistoryTableConfig };
