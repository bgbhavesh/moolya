...
export default class MlAppTaskPayment extends Component {
  ...
  handleBlurAmount(e) {
    ...
    const name = 'discountValue';
    const value = e.target.value || 0;
    const amount = this.state.data.payment ? this.state.data.payment.activitiesDerived : 0;
    let derivedAmount = 0;
    if (!isNaN(value)) {
    ...
    details.payment = _.extend(details.payment, { [name]: value, derivedAmount });
            ...
            <div className="centered_form">
              <form>
                <div className="form-group">
                  <label>Activity gross payable amount &nbsp;<label>{data.payment && data.payment.currencyType ? data.payment.currencyType : this.state.currencySymbol}</label>&nbsp;<input
                ...
                <div className="form-group">
                  <label>Activity discount payable amount &nbsp;<label>{data.payment && data.payment.currencyType ? data.payment.currencyType : this.state.currencySymbol}</label>&nbsp;<input
                    className="form-control inline_input medium_in"
                ...
                <div className="form-group">
                  <label>Activity net payable amount &nbsp;<label>{data.payment && data.payment.currencyType ? data.payment.currencyType : this.state.currencySymbol}</label>&nbsp;<input
                    className="form-control inline_input medium_in"
                ...
                <div className="form-group switch_wrap switch_names inline_switch">
                  ...
                  <span htmlFor="discount" className={(data.payment && data.payment.isDiscount) ? 'state_label acLabel' : 'state_label'}>Yes</span><label className="switch nocolor-switch">
                    <input
                      id="discount" type="checkbox" name="isDiscount"
                ...
                <div className="form-group">
                  <div className="input_types">
                    <input
                      id="radio1" type="radio" name="radio1" value="1"
                      disabled={!(data.payment && data.payment.isDiscount)}
                      checked={!!((data.payment && data.payment.discountType == 'amount'))}
                  ...
                  <div className="input_types">
                    <input
                      id="radio2" type="radio" name="radio1" value="2"
                      checked={!!((data.payment && data.payment.discountType == 'percent'))}
                      disabled={!(data.payment && data.payment.isDiscount)}
                ...
                <div className="form-group">
                  <label>Net payable amount &nbsp;<label>{data.payment && data.payment.currencyType ? data.payment.currencyType : this.state.currencySymbol}</label>&nbsp;<input
                    className="form-control inline_input medium_in"
