...
export default class MlStartupAwards extends Component {
  ...
  async fetchPortfolioDetails() {
    ...
    const awardsRecognition = that.context.startupPortfolio && that.context.startupPortfolio.awardsRecognition
    const empty = _.isEmpty(awardsRecognition)
  ...
  onSaveAction(e) {
    ...
    let setObject = this.state.startupAwards
  ...
  onTileClick(index, uiIndex, e) {
    const cloneArray = _.cloneDeep(this.state.startupAwards);
  ...
  lockPrivateKeys(selIndex) {
    const privateValues = this.startupAwardServer && this.startupAwardServer[selIndex] ? this.startupAwardServer[selIndex].privateFields : []
  ...
  sendDataToParent(isSaveClicked) {
    ...
    const awards = this.state.startupAwards;
  ...
  async fetchOnlyImages() {
    ...
    if (response && response.awardsRecognition) {
      const dataDetails = this.state.startupAwards
  ...
  render() {
    ...
    const startupAwardsList = that.state.startupAwardsList || [];
              ...
              <ScrollArea
                ...
                <div className="col-lg-12">
                  <div className="row">
                    ...
                    {startupAwardsList.map((details, idx) => (<div className="col-lg-2 col-md-3 col-sm-3" key={idx}>
