...
class MlAddRole extends React.Component {
  ...
  async addRole() {
    ...
    if (ret) {
      ...
      const emptyCluster = _.filter(roleDetails.assignRoles, ['cluster', ''])
      const emptyChapter = _.filter(roleDetails.assignRoles, ['chapter', ''])
      const emptySubChapter = _.filter(roleDetails.assignRoles, ['subChapter', ''])
      const emptyCommunity = _.filter(roleDetails.assignRoles, ['community', ''])
      const emptyDepartment = _.filter(roleDetails.assignRoles, ['department', ''])
      const emptySubDepartment = _.filter(roleDetails.assignRoles, ['subDepartment', ''])
