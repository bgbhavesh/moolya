...
export default class MlAppFunderViewTabs extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      tabs: [], aboutUs: {}, funderPortfolio: {}, activeTab: 'About'
    };
  }
  ...
  getTabComponents() {
    const tabs = [
      ...
      {
        tabClassName: 'tab', panelClassName: 'panel', title: 'Services', name: 'Services', component: <MlBeSpokeListView myPortfolio={true} key="10" portfolioDetailsId={this.props.portfolioDetailsId}/>
