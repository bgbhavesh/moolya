                  ...
                  >
                    <div className="form_bg">
                      <form>
                        ...
                        <div className="form-group">
                          <input type="text" placeholder="Industry" ref="industry" defaultValue={this.state.data.industryDisplayName} className="form-control float-label"  disabled="disabled"/>
