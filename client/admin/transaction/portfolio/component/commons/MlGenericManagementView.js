...
export default class MlGenericManagementView extends React.Component {
  ...
  render() {
    ...
    const arrayList = _this.props.data ? _this.props.data : []
                          ...
                          <div className="funding-investers" id="funding_show">
                            <div className="col-md-6 nopadding-left">
                              <div className="form_bg">
                                <form>
                                  <Moolyaselect
                                    multiSelect={false} placeholder="Title"
                                  ...
                                  <div className="form-group">
                                    <input
                                      type="text" placeholder="Joining Date to this company"
                                  ...
                                  <div className="form-group">
                                    <input
                                      type="text" placeholder="Joining date of first job"
                            ...
                            <div className="col-md-6 nopadding-right">
                              <div className="form_bg">
                                <form>
                                  ...
                                  <div className="form-group">
                                    <input
                                      type="text" placeholder="Certification"
                                  ...
                                  <div className="form-group">
                                    <input
                                      type="text" placeholder="Awards" className="form-control float-label"
