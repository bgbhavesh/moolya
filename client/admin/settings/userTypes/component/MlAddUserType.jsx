...
class MlAddUserType extends React.Component {
  ...
  async handleSuccess(response) {
    if (response) {
      if (response.success) { FlowRouter.go('/admin/settings/documentProcess/UserTypeList'); } else { toastr.error(response.result); }
    }
  }
        ...
        <div className="admin_padding_wrap">
          ...
          <div className="col-md-6 nopadding-left">
            <div className="form_bg">
              <form>
                <Moolyaselect
                  ref="Community " multiSelect={false} className="form-control float-label" valueKey={'value'}
