...
export default class MlStartupViewAbout extends React.Component {
  ...
  async createAnnotations(annotation) {
    const details = { portfolioId: this.props.portfolioDetailsId, docId: 'startupAbout', quote: JSON.stringify(annotation) }
  ...
  async fetchAnnotations(isCreate) {
    const response = await findAnnotations(this.props.portfolioDetailsId, 'startupAbout');
