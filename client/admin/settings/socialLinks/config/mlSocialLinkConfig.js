...
const mlSocialLinksTypeTableConfig = new MlViewer.View({
  ...
  columns: [
    ...
    {
      dataField: 'socialLinksInfo.socialName', title: 'Name', dataSort: true, customComponent(data) { return <div>{data.data.socialLinksInfo.socialName}</div> }
    },
    {
      dataField: 'socialLinksInfo.socialDisplayName', title: 'Display Name', dataSort: true, customComponent(data) { return <div>{data.data.socialLinksInfo.socialDisplayName}</div> }
    },
    {
      dataField: 'socialLinksInfo.aboutSocial', title: 'About', dataSort: true, customComponent(data) { return <div>{data.data.socialLinksInfo.aboutSocial}</div> }
    },
  ...
  sizePerPage: 5,
  queryOptions: true,
  buildQueryOptions: config => ({ context: { settingsType: 'SOCIALLINKS' } }),
  /*  graphQlQuery:gql`
