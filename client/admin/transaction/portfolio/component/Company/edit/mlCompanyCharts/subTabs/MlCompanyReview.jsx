...
export default class MlCompanyReview extends React.Component{
  ...
  componentWillMount(){
    let empty = _.isEmpty(this.context.companyPortfolio && this.context.companyPortfolio.reviewOfCompanyChart)
    if(!empty){
      this.setState({loading: false, startupCompanyReview: this.context.companyPortfolio.reviewOfCompanyChart, reviewList:this.context.companyPortfolio.reviewOfCompanyChart});
    }
  }
