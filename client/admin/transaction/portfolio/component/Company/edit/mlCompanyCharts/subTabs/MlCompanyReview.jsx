...
export default class MlCompanyReview extends React.Component{
  ...
  fetchDetails(){
    ...
    let empty = _.isEmpty(that.context.companyPortfolio && that.context.companyPortfolio.reviewOfCompanyChart)
    if(empty){
      this.setState({loading: false, startupCompanyReview: that.props.reviewDetails, reviewList: that.props.reviewDetails});
    }else{
      this.setState({loading: false, startupCompanyReview: that.context.companyPortfolio.reviewOfCompanyChart, reviewList:that.context.companyPortfolio.reviewOfCompanyChart});
    }
  }
        ...
        >
          <div className="panel panel-default">
            <div className="panel-heading">Company Review{
              <div className="pull-right block_action" onClick={this.onSaveAction.bind(this,defaultIndex)}><CDNImage
