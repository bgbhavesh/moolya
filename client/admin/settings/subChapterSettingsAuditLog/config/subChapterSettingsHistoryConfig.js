...
const mlsubChapterSettingsTabHistoryTableConfig = new MlViewer.View({
  name: 'auditLogTable',
  ...
  buildQueryOptions: config =>
    ({ context: { moduleName: 'GLOBALSETTINGS,MASTERSETTINGS,TAXATION,' } }), // return {context:{moduleName:"CLUSTER, SUBCHAPTER",clusterId:config.params&&config.params.clusterId?config.params.clusterId:null}}
...
export { mlsubChapterSettingsTabHistoryTableConfig };
