...
export default class MlAppRegContactDetails extends React.Component {
  ...
  async onEditingContact(index, value) {
    ...
    if (contactExist) {
      ...
      const ret = mlFieldValidations(refs)
      const countrycode = this.state.countryDetails.countryCode;
      const contactNumber = this.refs[`numberType${index}`] && this.refs[`numberType${index}`].value;
      const isValidPhoneNumber = validatedPhoneNumber(countrycode, contactNumber);
      if (ret) {
        toastr.error(ret);
      } else if (countrycode && !isValidPhoneNumber) {
          ...
          <div className="ml_tabs">
            ...
            <div className="tab-content clearfix">
              <div className={`tab-pane${this.state.activeTab}`} id="contactA">
                ...
                <div className="form-group">
                  <input
                    type="text" placeholder="Enter Country Code" defaultValue={defaultCountryCode}
