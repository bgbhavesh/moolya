          ...
          <div className="tab-content clearfix">
            ...
            <div className={`tab-pane${this.state.activeTab}`} id="1a">
              ...
              <div className="form-group mandatory">
                <input
                  type="text" ref={'name'} placeholder="Name" className="form-control float-label" id=""
                  data-required={true} data-errMsg="Name is required"/>
              </div>
              <div className="form-group mandatory">
                <input
                  type="text" ref={'addressFlat'} placeholder="Flat/House/Floor/Bulding No"
                  className="form-control float-label" id="" data-required={true}
                  data-errMsg="Flat/House/Floor/Bulding No is required"/>
              </div>
              <div className="form-group mandatory">
                <input
                  type="text" ref={'addressLocality'} placeholder="Colony/Street/Locality"
                  className="form-control float-label" id="" data-required={true}
                  data-errMsg="Colony/Street/Locality is required"/>
              </div>
              <div className="form-group">
                <input
                  type="text" ref={'addressLandmark'} placeholder="Landmark" className="form-control float-label"
                  id=""/>
              </div>
              <div className="form-group">
                <input
                  type="text" ref={'addressArea'} placeholder="Area"
              ...
              <div className="form-group mandatory">
                <input
                  type="text" ref={'addressCity'} placeholder="Town/City" className="form-control float-label"
            ...
            {that.state.addressDetails && (that.state.addressDetails.map((options, key) => (
              <div className="tab-pane" id={`adressType${key}`} key={key}>
                ...
                <div className="form-group mandatory">
                  <input
                    type="text" ref={`addressFlat${key}`} name={'addressFlat'}
                ...
                <div className="form-group">
                  <Moolyaselect
                    multiSelect={false} ref={`addressCountry${key}`} className="form-control float-label"
                    valueKey={'value'}
