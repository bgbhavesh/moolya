                ...
                <div className="row">
                  <div className="investement-view-content">
                    ...
                    <div className="funding-investers" id="funding_01" style={{'display':'block'}}>
                      ...
                      <p>NeoStencil is India’s only Ed Tech Company that provides live online classrooms from top teachers. With a mission statement of Choose Your Classroom, it aims to revolutionize test preparation in India by connecting teachers and students seamlessly. </p>
                    ...
                    <div className="funding-investers" id="funding_02">
                      ...
                      <p>Postmates is transforming the way local goods move around a city by enabling anyone to get any product delivered in under one hour. Postmates' revolutionary urban logistics & on-demand delivery platform connects customers with local couriers, who purchase and deliver goods from any restaurant or store in a city.</p>
                      ...
                      <p>Change.org is the world's largest technology platform for social change. Our goal is to empower people everywhere to start campaigns around the issues they care about, mobilize others, and work with decision makers to drive solutions.</p>

                      <p>We’re also an innovative business – a "social enterprise” and a certified B Corporation, with a business model designed to support positive social impact (more about B Corps: www.bcorporation.net).</p>

                      <p>Over 130 million people have started and signed petitions, and our users win nearly one victory per hour, including strengthening hate crime legislation in South Africa; fighting corruption in Indonesia, Italy, and Brazil; ending the ban on gay Boy Scouts in the United States, and big wins for women’s rights in India. And we’re just getting started.</p>
                    ...
                    <div className="funding-investers" id="funding_03">
                      ...
                      <p>Customers place requests through a simple form and receive detailed templatized quotes along with photographer portfolios allowing them to make decisions from their living room.</p>

                      <p>On Flatpebble, photographers view detailed requirements, budgets and verified customer info before deciding to quote on a lead. It also helps that Wedding photography is in their TAM a 450-500 mn $ market, completely disorganized and crying out for high quality organisation.</p>

                      <p>Flatpebble is getting great customer and photographer feedback. They have grown to over 500 + portfolios across 80+ Indian cities and 5+ countries as on date.</p>
                    </div>
                    ...
                    <div className="funding-investers" id="funding_04">
                      ...
                      <p>Oddup is a data driven research platform that gives you analytical information on startups. We give ratings and a curated view on the potential success of a startup.</p>
                    </div>
