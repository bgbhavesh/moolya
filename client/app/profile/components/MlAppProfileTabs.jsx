...
export default class MlAppProfileTabs extends React.Component {
  ...
  getTabComponents() {
    const tabs = [
      {
        tabClassName: 'tab', panelClassName: 'panel', title: 'Personal Info', component: <MlMyProfile key="1"/>
      }, // this.props.portfolioDetailsId}
      {
        tabClassName: 'tab', panelClassName: 'panel', title: 'Address Book', component: <MyProfileAddressBook key="2"/>
      }, // id will be dyanmic
      {
        tabClassName: 'tab', panelClassName: 'panel', title: 'Settings', component: <MyProfileSettings key="3" />
      },
      {
        tabClassName: 'tab', panelClassName: 'panel', title: 'Library', component: <PortfolioLibrary key="4" isAdmin={false} client={appClient}/>
      } // id will be dyanmic
    ]
    return tabs;
  }
