...
import {fetctOfficeDayAppointmentActionHandler} from './../actions/fetchOfficeDayAppointment';

export default class MlAppOfficeCalendarDay extends React.Component {
  ...
  async getMyAppointment() {
    ...
    let response = await fetctOfficeDayAppointmentActionHandler(userId, profile, day, month, year);
    if (response) {
      this.setState({
        slots: response
      });
