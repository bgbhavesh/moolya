...
const mlClusterSubChaptersListConfig = new MlViewer.View({
  ...
  sort: true,
  queryOptions: true,
  buildQueryOptions: config => ({ context: { clusterId: config.params && config.params.clusterId ? config.params.clusterId : null, chapterId: config.params && config.params.chapterId ? config.params.chapterId : null } }),
