...
export default class RegisterForm extends React.Component{
  ...
  render(){
    ...
    [
      ...
      {name: 'Contact details','icon':<span className="ml ml-moolya-symbol"></span>, component: <Step3 getRegistrationContactDetails={this.getRegistrationContactDetails.bind(this)} registrationInfo={this.state.registrationDetails}  registrationId={registrationId} clusterId={this.state.registrationDetails&&this.state.registrationDetails.registrationInfo.clusterId}/>},
